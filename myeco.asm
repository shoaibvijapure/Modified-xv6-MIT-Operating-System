...
main(int argc, char *argv[])
{
  ...
  1f:	7e 2f                	jle    50 <main+0x50>
  21:	8d 58 04             	lea    0x4(%eax),%ebx
  24:	8d 34 90             	lea    (%eax,%edx,4),%esi
...
free(void *ap)
{
 ...
 675:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 ec 0a 00 00       	mov    0xaec,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 ...
 7d7:	0a 00 00 
    base.s.size = 0;
 7da:	bf f0 0a 00 00       	mov    $0xaf0,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7e6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 7f2:	00 00 00 
    if(p->s.size >= nunits){
