...
int main(void)
{
   ...
   7:	83 e4 f0             	and    $0xfffffff0,%esp
    halt();
   a:	e8 34 03 00 00       	call   343 <halt>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 4f9:	e8 a5 fd ff ff       	call   2a3 <write>
        putc(fd, c);
      } else {
 ...
 581:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 584:	e8 1a fd ff ff       	call   2a3 <write>
        ap++;
 ...
 5fb:	57                   	push   %edi
 5fc:	53                   	push   %ebx
 5fd:	e8 a1 fc ff ff       	call   2a3 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 71b:	e8 eb fb ff ff       	call   30b <sbrk>
  if(p == (char*)-1)
