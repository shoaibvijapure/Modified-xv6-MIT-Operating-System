...
_pinfo_test:     file format elf32-i386
  ...
  16:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  24:	e8 57 02 00 00       	call   280 <atoi>
  29:	5a                   	pop    %edx
  2a:	59                   	pop    %ecx
  2b:	50                   	push   %eax
  2c:	8d 45 d4             	lea    -0x2c(%ebp),%eax
  2f:	50                   	push   %eax
  30:	e8 6e 03 00 00       	call   3a3 <getpinfo>
  ...
  46:	ff 75 d4             	pushl  -0x2c(%ebp)
  49:	68 68 08 00 00       	push   $0x868
  4e:	6a 01                	push   $0x1
  ...
  63:	e8 18 02 00 00       	call   280 <atoi>
  ...
  7d:	53                   	push   %ebx
  7e:	53                   	push   %ebx
  7f:	68 28 08 00 00       	push   $0x828
  84:	6a 02                	push   $0x2
  86:	e8 35 04 00 00       	call   4c0 <printf>
  8b:	83 c4 10             	add    $0x10,%esp
  8e:	eb c8                	jmp    58 <main+0x58>
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 a0 08 00 00 	movzbl 0x8a0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	eb 1a                	jmp    660 <printf+0x1a0>
          s = "(null)";
 646:	bb 97 08 00 00       	mov    $0x897,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 695:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 6e7:	5e                   	pop    %esi
 6e8:	5f                   	pop    %edi
 6e9:	5d                   	pop    %ebp
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 4c 0b 00 00       	mov    0xb4c,%eax
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf 50 0b 00 00       	mov    $0xb50,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 812:	00 00 00 
    if(p->s.size >= nunits){
