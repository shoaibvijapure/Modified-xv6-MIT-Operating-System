  ...
  12:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  15:	83 ec 30             	sub    $0x30,%esp
    if (date(&r)) {
  18:	50                   	push   %eax
  19:	e8 6d 03 00 00       	call   38b <date>
  ...
  38:	ff 75 e0             	pushl  -0x20(%ebp)
  3b:	ff 75 e4             	pushl  -0x1c(%ebp)
  3e:	ff 75 e8             	pushl  -0x18(%ebp)
  41:	ff 75 ec             	pushl  -0x14(%ebp)
  44:	ff 75 f0             	pushl  -0x10(%ebp)
  47:	ff 75 f4             	pushl  -0xc(%ebp)
  4a:	68 05 08 00 00       	push   $0x805
  4f:	6a 01                	push   $0x1
  51:	e8 3a 04 00 00       	call   490 <printf>
    exit();
  56:	83 c4 20             	add    $0x20,%esp
  59:	e8 65 02 00 00       	call   2c3 <exit>
  5e:	66 90                	xchg   %ax,%ax
