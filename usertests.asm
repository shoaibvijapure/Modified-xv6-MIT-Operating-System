...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      15:	68 a6 4e 00 00       	push   $0x4ea6
      1a:	6a 01                	push   $0x1
      1c:	e8 2f 3b 00 00       	call   3b50 <printf>

  if(open("usertests.ran", 0) >= 0){
      21:	59                   	pop    %ecx
      22:	58                   	pop    %eax
      23:	6a 00                	push   $0x0
      25:	68 ba 4e 00 00       	push   $0x4eba
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      36:	52                   	push   %edx
      37:	52                   	push   %edx
      38:	68 24 56 00 00       	push   $0x5624
      3d:	6a 01                	push   $0x1
      3f:	e8 0c 3b 00 00       	call   3b50 <printf>
    exit();
...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     12a:	68 4c 3f 00 00       	push   $0x3f4c
     12f:	ff 35 50 5f 00 00    	pushl  0x5f50
     135:	e8 16 3a 00 00       	call   3b50 <printf>
  if(mkdir("iputdir") < 0){
     13a:	c7 04 24 df 3e 00 00 	movl   $0x3edf,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     150:	68 df 3e 00 00       	push   $0x3edf
  ...
  if(unlink("../iputdir") < 0){
     ...
     168:	68 dc 3e 00 00       	push   $0x3edc
  ...
  if(chdir("/") < 0){
     ...
     17c:	68 01 3f 00 00       	push   $0x3f01
  ...
  printf(stdout, "iput test ok\n");
     ...
     190:	68 84 3f 00 00       	push   $0x3f84
     195:	ff 35 50 5f 00 00    	pushl  0x5f50
     19b:	e8 b0 39 00 00       	call   3b50 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     1a5:	50                   	push   %eax
     1a6:	50                   	push   %eax
     1a7:	68 b8 3e 00 00       	push   $0x3eb8
     1ac:	ff 35 50 5f 00 00    	pushl  0x5f50
     1b2:	e8 99 39 00 00       	call   3b50 <printf>
    exit();
     1b7:	e8 c7 37 00 00       	call   3983 <exit>
    printf(stdout, "chdir / failed\n");
     1bc:	50                   	push   %eax
     1bd:	50                   	push   %eax
     1be:	68 03 3f 00 00       	push   $0x3f03
     1c3:	ff 35 50 5f 00 00    	pushl  0x5f50
     1c9:	e8 82 39 00 00       	call   3b50 <printf>
    exit();
     1ce:	e8 b0 37 00 00       	call   3983 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1d3:	52                   	push   %edx
     1d4:	52                   	push   %edx
     1d5:	68 e7 3e 00 00       	push   $0x3ee7
     1da:	ff 35 50 5f 00 00    	pushl  0x5f50
     1e0:	e8 6b 39 00 00       	call   3b50 <printf>
    exit();
     1e5:	e8 99 37 00 00       	call   3983 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1ea:	51                   	push   %ecx
     1eb:	51                   	push   %ecx
     1ec:	68 c6 3e 00 00       	push   $0x3ec6
     1f1:	ff 35 50 5f 00 00    	pushl  0x5f50
     1f7:	e8 54 39 00 00       	call   3b50 <printf>
    exit();
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     21a:	68 13 3f 00 00       	push   $0x3f13
     21f:	ff 35 50 5f 00 00    	pushl  0x5f50
     225:	e8 26 39 00 00       	call   3b50 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     23f:	68 df 3e 00 00       	push   $0x3edf
    ...
    if(chdir("iputdir") < 0){
     ...
     257:	68 df 3e 00 00       	push   $0x3edf
    ...
    if(unlink("../iputdir") < 0){
     ...
     26f:	68 dc 3e 00 00       	push   $0x3edc
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     290:	68 36 3f 00 00       	push   $0x3f36
     295:	ff 35 50 5f 00 00    	pushl  0x5f50
     29b:	e8 b0 38 00 00       	call   3b50 <printf>
}
     ...
     2ab:	68 e7 3e 00 00       	push   $0x3ee7
     2b0:	ff 35 50 5f 00 00    	pushl  0x5f50
     2b6:	e8 95 38 00 00       	call   3b50 <printf>
      exit();
     2bb:	e8 c3 36 00 00       	call   3983 <exit>
    printf(stdout, "fork failed\n");
     2c0:	51                   	push   %ecx
     2c1:	51                   	push   %ecx
     2c2:	68 f9 4d 00 00       	push   $0x4df9
     2c7:	ff 35 50 5f 00 00    	pushl  0x5f50
     2cd:	e8 7e 38 00 00       	call   3b50 <printf>
    exit();
     2d2:	e8 ac 36 00 00       	call   3983 <exit>
      printf(stdout, "mkdir failed\n");
     2d7:	52                   	push   %edx
     2d8:	52                   	push   %edx
     2d9:	68 b8 3e 00 00       	push   $0x3eb8
     2de:	ff 35 50 5f 00 00    	pushl  0x5f50
     2e4:	e8 67 38 00 00       	call   3b50 <printf>
      exit();
     2e9:	e8 95 36 00 00       	call   3983 <exit>
      printf(stdout, "child chdir failed\n");
     2ee:	50                   	push   %eax
     2ef:	50                   	push   %eax
     2f0:	68 22 3f 00 00       	push   $0x3f22
     2f5:	ff 35 50 5f 00 00    	pushl  0x5f50
     2fb:	e8 50 38 00 00       	call   3b50 <printf>
      exit();
...
00000310 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     31a:	68 48 3f 00 00       	push   $0x3f48
     31f:	ff 35 50 5f 00 00    	pushl  0x5f50
     325:	e8 26 38 00 00       	call   3b50 <printf>
  if(mkdir("oidir") < 0){
     32a:	c7 04 24 57 3f 00 00 	movl   $0x3f57,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     34f:	6a 02                	push   $0x2
     351:	68 57 3f 00 00       	push   $0x3f57
    ...
    if(fd >= 0){
     ...
     365:	68 dc 4e 00 00       	push   $0x4edc
     36a:	ff 35 50 5f 00 00    	pushl  0x5f50
     370:	e8 db 37 00 00       	call   3b50 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     38a:	c7 04 24 57 3f 00 00 	movl   $0x3f57,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3a5:	68 80 3f 00 00       	push   $0x3f80
     3aa:	ff 35 50 5f 00 00    	pushl  0x5f50
     3b0:	e8 9b 37 00 00       	call   3b50 <printf>
    ...
    printf(stdout, "fork failed\n");
     3c5:	52                   	push   %edx
     3c6:	52                   	push   %edx
     3c7:	68 f9 4d 00 00       	push   $0x4df9
     3cc:	ff 35 50 5f 00 00    	pushl  0x5f50
     3d2:	e8 79 37 00 00       	call   3b50 <printf>
    exit();
     3d7:	e8 a7 35 00 00       	call   3983 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3dc:	51                   	push   %ecx
     3dd:	51                   	push   %ecx
     3de:	68 5d 3f 00 00       	push   $0x3f5d
     3e3:	ff 35 50 5f 00 00    	pushl  0x5f50
     3e9:	e8 62 37 00 00       	call   3b50 <printf>
    exit();
     3ee:	e8 90 35 00 00       	call   3983 <exit>
    printf(stdout, "unlink failed\n");
     3f3:	50                   	push   %eax
     3f4:	50                   	push   %eax
     3f5:	68 71 3f 00 00       	push   $0x3f71
     3fa:	ff 35 50 5f 00 00    	pushl  0x5f50
     400:	e8 4b 37 00 00       	call   3b50 <printf>
    exit();
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     41a:	68 92 3f 00 00       	push   $0x3f92
     41f:	ff 35 50 5f 00 00    	pushl  0x5f50
     425:	e8 26 37 00 00       	call   3b50 <printf>
  fd = open("echo", 0);
     42a:	58                   	pop    %eax
     42b:	5a                   	pop    %edx
     42c:	6a 00                	push   $0x0
     42e:	68 9d 3f 00 00       	push   $0x3f9d
  ...
  fd = open("doesnotexist", 0);
     ...
     449:	59                   	pop    %ecx
     44a:	6a 00                	push   $0x0
     44c:	68 b5 3f 00 00       	push   $0x3fb5
  ...
  printf(stdout, "open test ok\n");
     ...
     460:	68 e0 3f 00 00       	push   $0x3fe0
     465:	ff 35 50 5f 00 00    	pushl  0x5f50
     46b:	e8 e0 36 00 00       	call   3b50 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     475:	50                   	push   %eax
     476:	50                   	push   %eax
     477:	68 a2 3f 00 00       	push   $0x3fa2
     47c:	ff 35 50 5f 00 00    	pushl  0x5f50
     482:	e8 c9 36 00 00       	call   3b50 <printf>
    exit();
     487:	e8 f7 34 00 00       	call   3983 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     48c:	50                   	push   %eax
     48d:	50                   	push   %eax
     48e:	68 c2 3f 00 00       	push   $0x3fc2
     493:	ff 35 50 5f 00 00    	pushl  0x5f50
     499:	e8 b2 36 00 00       	call   3b50 <printf>
    exit();
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4bc:	68 ee 3f 00 00       	push   $0x3fee
     4c1:	ff 35 50 5f 00 00    	pushl  0x5f50
     4c7:	e8 84 36 00 00       	call   3b50 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     4cc:	58                   	pop    %eax
     4cd:	5a                   	pop    %edx
     4ce:	68 02 02 00 00       	push   $0x202
     4d3:	68 ff 3f 00 00       	push   $0x3fff
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4ef:	68 05 40 00 00       	push   $0x4005
     4f4:	ff 35 50 5f 00 00    	pushl  0x5f50
     4fa:	e8 51 36 00 00       	call   3b50 <printf>
     4ff:	83 c4 10             	add    $0x10,%esp
     502:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     508:	83 ec 04             	sub    $0x4,%esp
     50b:	6a 0a                	push   $0xa
     50d:	68 3c 40 00 00       	push   $0x403c
     512:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     527:	6a 0a                	push   $0xa
     529:	68 47 40 00 00       	push   $0x4047
     52e:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     54b:	68 52 40 00 00       	push   $0x4052
     550:	ff 35 50 5f 00 00    	pushl  0x5f50
     556:	e8 f5 35 00 00       	call   3b50 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     564:	5e                   	pop    %esi
     565:	6a 00                	push   $0x0
     567:	68 ff 3f 00 00       	push   $0x3fff
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     581:	68 5d 40 00 00       	push   $0x405d
     586:	ff 35 50 5f 00 00    	pushl  0x5f50
     58c:	e8 bf 35 00 00       	call   3b50 <printf>
  i = read(fd, buf, 2000);
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5b5:	68 91 40 00 00       	push   $0x4091
     5ba:	ff 35 50 5f 00 00    	pushl  0x5f50
     5c0:	e8 8b 35 00 00       	call   3b50 <printf>
  close(fd);
     5c5:	89 1c 24             	mov    %ebx,(%esp)
     5c8:	e8 de 33 00 00       	call   39ab <close>
  if(unlink("small") < 0){
     5cd:	c7 04 24 ff 3f 00 00 	movl   $0x3fff,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e3:	68 b9 40 00 00       	push   $0x40b9
     5e8:	ff 35 50 5f 00 00    	pushl  0x5f50
     5ee:	e8 5d 35 00 00       	call   3b50 <printf>
}
     ...
     600:	53                   	push   %ebx
     601:	68 00 4f 00 00       	push   $0x4f00
     606:	ff 35 50 5f 00 00    	pushl  0x5f50
     60c:	e8 3f 35 00 00       	call   3b50 <printf>
      exit();
     611:	e8 6d 33 00 00       	call   3983 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     616:	83 ec 04             	sub    $0x4,%esp
     619:	53                   	push   %ebx
     61a:	68 24 4f 00 00       	push   $0x4f24
     61f:	ff 35 50 5f 00 00    	pushl  0x5f50
     625:	e8 26 35 00 00       	call   3b50 <printf>
      exit();
     62a:	e8 54 33 00 00       	call   3983 <exit>
    printf(stdout, "error: open small failed!\n");
     62f:	51                   	push   %ecx
     630:	51                   	push   %ecx
     631:	68 76 40 00 00       	push   $0x4076
     636:	ff 35 50 5f 00 00    	pushl  0x5f50
     63c:	e8 0f 35 00 00       	call   3b50 <printf>
    exit();
     641:	e8 3d 33 00 00       	call   3983 <exit>
    printf(stdout, "read failed\n");
     646:	52                   	push   %edx
     647:	52                   	push   %edx
     648:	68 bd 43 00 00       	push   $0x43bd
     64d:	ff 35 50 5f 00 00    	pushl  0x5f50
     653:	e8 f8 34 00 00       	call   3b50 <printf>
    exit();
     658:	e8 26 33 00 00       	call   3983 <exit>
    printf(stdout, "unlink small failed\n");
     65d:	50                   	push   %eax
     65e:	50                   	push   %eax
     65f:	68 a4 40 00 00       	push   $0x40a4
     664:	ff 35 50 5f 00 00    	pushl  0x5f50
     66a:	e8 e1 34 00 00       	call   3b50 <printf>
    exit();
     66f:	e8 0f 33 00 00       	call   3983 <exit>
    printf(stdout, "error: creat small failed!\n");
     674:	50                   	push   %eax
     675:	50                   	push   %eax
     676:	68 20 40 00 00       	push   $0x4020
     67b:	ff 35 50 5f 00 00    	pushl  0x5f50
     681:	e8 ca 34 00 00       	call   3b50 <printf>
    exit();
...
00000690 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     69c:	68 cd 40 00 00       	push   $0x40cd
     6a1:	ff 35 50 5f 00 00    	pushl  0x5f50
     6a7:	e8 a4 34 00 00       	call   3b50 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     6ac:	58                   	pop    %eax
     6ad:	5a                   	pop    %edx
     6ae:	68 02 02 00 00       	push   $0x202
     6b3:	68 47 41 00 00       	push   $0x4147
  ...
  fd = open("big", O_RDONLY);
     ...
     70c:	5e                   	pop    %esi
     70d:	6a 00                	push   $0x0
     70f:	68 47 41 00 00       	push   $0x4147
  ...
  if(unlink("big") < 0){
     776:	c7 04 24 47 41 00 00 	movl   $0x4147,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     790:	68 6e 41 00 00       	push   $0x416e
     795:	ff 35 50 5f 00 00    	pushl  0x5f50
     79b:	e8 b0 33 00 00       	call   3b50 <printf>
}
     ...
     7ad:	53                   	push   %ebx
     7ae:	68 f7 40 00 00       	push   $0x40f7
     7b3:	ff 35 50 5f 00 00    	pushl  0x5f50
     7b9:	e8 92 33 00 00       	call   3b50 <printf>
      exit();
     7be:	e8 c0 31 00 00       	call   3983 <exit>
      printf(stdout, "read content of block %d is %d\n",
     7c3:	50                   	push   %eax
     7c4:	56                   	push   %esi
     7c5:	68 48 4f 00 00       	push   $0x4f48
     7ca:	ff 35 50 5f 00 00    	pushl  0x5f50
     7d0:	e8 7b 33 00 00       	call   3b50 <printf>
      exit();
     7d5:	e8 a9 31 00 00       	call   3983 <exit>
      printf(stdout, "read failed %d\n", i);
     7da:	83 ec 04             	sub    $0x4,%esp
     7dd:	50                   	push   %eax
     7de:	68 4b 41 00 00       	push   $0x414b
     7e3:	ff 35 50 5f 00 00    	pushl  0x5f50
     7e9:	e8 62 33 00 00       	call   3b50 <printf>
      exit();
     7ee:	e8 90 31 00 00       	call   3983 <exit>
        printf(stdout, "read only %d blocks from big", n);
     7f3:	52                   	push   %edx
     7f4:	68 8b 00 00 00       	push   $0x8b
     7f9:	68 2e 41 00 00       	push   $0x412e
     7fe:	ff 35 50 5f 00 00    	pushl  0x5f50
     804:	e8 47 33 00 00       	call   3b50 <printf>
        exit();
     809:	e8 75 31 00 00       	call   3983 <exit>
    printf(stdout, "error: open big failed!\n");
     80e:	51                   	push   %ecx
     80f:	51                   	push   %ecx
     810:	68 15 41 00 00       	push   $0x4115
     815:	ff 35 50 5f 00 00    	pushl  0x5f50
     81b:	e8 30 33 00 00       	call   3b50 <printf>
    exit();
     820:	e8 5e 31 00 00       	call   3983 <exit>
    printf(stdout, "error: creat big failed!\n");
     825:	50                   	push   %eax
     826:	50                   	push   %eax
     827:	68 dd 40 00 00       	push   $0x40dd
     82c:	ff 35 50 5f 00 00    	pushl  0x5f50
     832:	e8 19 33 00 00       	call   3b50 <printf>
    exit();
     837:	e8 47 31 00 00       	call   3983 <exit>
    printf(stdout, "unlink big failed\n");
     83c:	50                   	push   %eax
     83d:	50                   	push   %eax
     83e:	68 5b 41 00 00       	push   $0x415b
     843:	ff 35 50 5f 00 00    	pushl  0x5f50
     849:	e8 02 33 00 00       	call   3b50 <printf>
    exit();
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     870:	68 68 4f 00 00       	push   $0x4f68
     875:	ff 35 50 5f 00 00    	pushl  0x5f50
     87b:	e8 d0 32 00 00       	call   3b50 <printf>
  name[0] = 'a';
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     901:	68 90 4f 00 00       	push   $0x4f90
     906:	ff 35 50 5f 00 00    	pushl  0x5f50
     90c:	e8 3f 32 00 00       	call   3b50 <printf>
}
...
00000920 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     92a:	68 7c 41 00 00       	push   $0x417c
     92f:	ff 35 50 5f 00 00    	pushl  0x5f50
     935:	e8 16 32 00 00       	call   3b50 <printf>
  if(mkdir("dir0") < 0){
     93a:	c7 04 24 88 41 00 00 	movl   $0x4188,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     950:	68 88 41 00 00       	push   $0x4188
  ...
  if(chdir("..") < 0){
     ...
     968:	68 2d 47 00 00       	push   $0x472d
  ...
  if(unlink("dir0") < 0){
     ...
     97c:	68 88 41 00 00       	push   $0x4188
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     990:	68 c5 41 00 00       	push   $0x41c5
     995:	ff 35 50 5f 00 00    	pushl  0x5f50
     99b:	e8 b0 31 00 00       	call   3b50 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     9a5:	50                   	push   %eax
     9a6:	50                   	push   %eax
     9a7:	68 b8 3e 00 00       	push   $0x3eb8
     9ac:	ff 35 50 5f 00 00    	pushl  0x5f50
     9b2:	e8 99 31 00 00       	call   3b50 <printf>
    exit();
     9b7:	e8 c7 2f 00 00       	call   3983 <exit>
    printf(stdout, "unlink dir0 failed\n");
     9bc:	50                   	push   %eax
     9bd:	50                   	push   %eax
     9be:	68 b1 41 00 00       	push   $0x41b1
     9c3:	ff 35 50 5f 00 00    	pushl  0x5f50
     9c9:	e8 82 31 00 00       	call   3b50 <printf>
    exit();
     9ce:	e8 b0 2f 00 00       	call   3983 <exit>
    printf(stdout, "chdir .. failed\n");
     9d3:	52                   	push   %edx
     9d4:	52                   	push   %edx
     9d5:	68 a0 41 00 00       	push   $0x41a0
     9da:	ff 35 50 5f 00 00    	pushl  0x5f50
     9e0:	e8 6b 31 00 00       	call   3b50 <printf>
    exit();
     9e5:	e8 99 2f 00 00       	call   3983 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9ea:	51                   	push   %ecx
     9eb:	51                   	push   %ecx
     9ec:	68 8d 41 00 00       	push   $0x418d
     9f1:	ff 35 50 5f 00 00    	pushl  0x5f50
     9f7:	e8 54 31 00 00       	call   3b50 <printf>
    exit();
...
00000a10 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     a1a:	68 d4 41 00 00       	push   $0x41d4
     a1f:	ff 35 50 5f 00 00    	pushl  0x5f50
     a25:	e8 26 31 00 00       	call   3b50 <printf>
  if(exec("echo", echoargv) < 0){
     a2a:	5a                   	pop    %edx
     a2b:	59                   	pop    %ecx
     a2c:	68 54 5f 00 00       	push   $0x5f54
     a31:	68 9d 3f 00 00       	push   $0x3f9d
    ...
    printf(stdout, "exec echo failed\n");
     a44:	50                   	push   %eax
     a45:	50                   	push   %eax
     a46:	68 df 41 00 00       	push   $0x41df
     a4b:	ff 35 50 5f 00 00    	pushl  0x5f50
     a51:	e8 fa 30 00 00       	call   3b50 <printf>
    exit();
     ...
     a69:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     b04:	68 0e 42 00 00       	push   $0x420e
     b09:	6a 01                	push   $0x1
     b0b:	e8 40 30 00 00       	call   3b50 <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     b8e:	5a                   	pop    %edx
     b8f:	59                   	pop    %ecx
     b90:	68 33 42 00 00       	push   $0x4233
     b95:	6a 01                	push   $0x1
     b97:	e8 b4 2f 00 00       	call   3b50 <printf>
     b9c:	83 c4 10             	add    $0x10,%esp
     b9f:	e9 6f ff ff ff       	jmp    b13 <pipe1+0xb3>
      printf(1, "pipe1 oops 3 total %d\n", total);
     ba4:	53                   	push   %ebx
     ba5:	ff 75 d4             	pushl  -0x2c(%ebp)
     ba8:	68 1c 42 00 00       	push   $0x421c
     bad:	6a 01                	push   $0x1
     baf:	e8 9c 2f 00 00       	call   3b50 <printf>
      exit();
     bb4:	e8 ca 2d 00 00       	call   3983 <exit>
    printf(1, "pipe() failed\n");
     bb9:	57                   	push   %edi
     bba:	57                   	push   %edi
     bbb:	68 f1 41 00 00       	push   $0x41f1
     bc0:	6a 01                	push   $0x1
     bc2:	e8 89 2f 00 00       	call   3b50 <printf>
    exit();
     bc7:	e8 b7 2d 00 00       	call   3983 <exit>
    printf(1, "fork() failed\n");
     bcc:	50                   	push   %eax
     bcd:	50                   	push   %eax
     bce:	68 3d 42 00 00       	push   $0x423d
     bd3:	6a 01                	push   $0x1
     bd5:	e8 76 2f 00 00       	call   3b50 <printf>
    exit();
     bda:	e8 a4 2d 00 00       	call   3983 <exit>
        printf(1, "pipe1 oops 1\n");
     bdf:	56                   	push   %esi
     be0:	56                   	push   %esi
     be1:	68 00 42 00 00       	push   $0x4200
     be6:	6a 01                	push   $0x1
     be8:	e8 63 2f 00 00       	call   3b50 <printf>
        exit();
...
00000c00 <preempt>:
{
  ...
  printf(1, "preempt: ");
     c0d:	68 4c 42 00 00       	push   $0x424c
     c12:	6a 01                	push   $0x1
     c14:	e8 37 2f 00 00       	call   3b50 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c68:	6a 01                	push   $0x1
     c6a:	68 11 48 00 00       	push   $0x4811
  ...
  printf(1, "kill... ");
     ccb:	58                   	pop    %eax
     ccc:	5a                   	pop    %edx
     ccd:	68 7d 42 00 00       	push   $0x427d
     cd2:	6a 01                	push   $0x1
     cd4:	e8 77 2e 00 00       	call   3b50 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     cf1:	59                   	pop    %ecx
     cf2:	5b                   	pop    %ebx
     cf3:	68 86 42 00 00       	push   $0x4286
     cf8:	6a 01                	push   $0x1
     cfa:	e8 51 2e 00 00       	call   3b50 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     d0e:	5e                   	pop    %esi
     d0f:	5f                   	pop    %edi
     d10:	68 8f 42 00 00       	push   $0x428f
     d15:	6a 01                	push   $0x1
     d17:	e8 34 2e 00 00       	call   3b50 <printf>
     ...
     d2f:	6a 01                	push   $0x1
     d31:	e8 1a 2e 00 00       	call   3b50 <printf>
     d36:	83 c4 10             	add    $0x10,%esp
     d39:	e9 45 ff ff ff       	jmp    c83 <preempt+0x83>
    printf(1, "preempt read error");
     d3e:	83 ec 08             	sub    $0x8,%esp
     d41:	68 6a 42 00 00       	push   $0x426a
     d46:	6a 01                	push   $0x1
     d48:	e8 03 2e 00 00       	call   3b50 <printf>
    return;
...
00000d60 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d8e:	68 f9 4d 00 00       	push   $0x4df9
     d93:	6a 01                	push   $0x1
     d95:	e8 b6 2d 00 00       	call   3b50 <printf>
      return;
     ...
     dab:	68 9b 42 00 00       	push   $0x429b
     db0:	6a 01                	push   $0x1
     db2:	e8 99 2d 00 00       	call   3b50 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     dc4:	68 ab 42 00 00       	push   $0x42ab
     dc9:	6a 01                	push   $0x1
     dcb:	e8 80 2d 00 00       	call   3b50 <printf>
...
00000de0 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     dee:	68 b8 42 00 00       	push   $0x42b8
     df3:	6a 01                	push   $0x1
     df5:	e8 56 2d 00 00       	call   3b50 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     e24:	e8 87 2f 00 00       	call   3db0 <malloc>
    ...
    while(m1){
     ...
     e3d:	8b 36                	mov    (%esi),%esi
      free(m1);
     e3f:	50                   	push   %eax
     e40:	e8 db 2e 00 00       	call   3d20 <free>
    while(m1){
    ...
    m1 = malloc(1024*20);
     ...
     e54:	e8 57 2f 00 00       	call   3db0 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     e63:	50                   	push   %eax
     e64:	e8 b7 2e 00 00       	call   3d20 <free>
    printf(1, "mem ok\n");
     e69:	58                   	pop    %eax
     e6a:	5a                   	pop    %edx
     e6b:	68 dc 42 00 00       	push   $0x42dc
     e70:	6a 01                	push   $0x1
     e72:	e8 d9 2c 00 00       	call   3b50 <printf>
    exit();
     e77:	e8 07 2b 00 00       	call   3983 <exit>
     e7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      printf(1, "couldn't allocate mem?!!\n");
     e80:	83 ec 08             	sub    $0x8,%esp
     e83:	68 c2 42 00 00       	push   $0x42c2
     e88:	6a 01                	push   $0x1
     e8a:	e8 c1 2c 00 00       	call   3b50 <printf>
      kill(ppid);
...
00000eb0 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     ebd:	68 e4 42 00 00       	push   $0x42e4
     ec2:	6a 01                	push   $0x1
     ec4:	e8 87 2c 00 00       	call   3b50 <printf>
  unlink("sharedfd");
     ec9:	c7 04 24 f3 42 00 00 	movl   $0x42f3,(%esp)
     ed0:	e8 fe 2a 00 00       	call   39d3 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     ed5:	5b                   	pop    %ebx
     ed6:	5e                   	pop    %esi
     ed7:	68 02 02 00 00       	push   $0x202
     edc:	68 f3 42 00 00       	push   $0x42f3
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f3c:	68 e4 4f 00 00       	push   $0x4fe4
     f41:	6a 01                	push   $0x1
     f43:	e8 08 2c 00 00       	call   3b50 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f6a:	5a                   	pop    %edx
     f6b:	6a 00                	push   $0x0
     f6d:	68 f3 42 00 00       	push   $0x42f3
  ...
  unlink("sharedfd");
     fdb:	c7 04 24 f3 42 00 00 	movl   $0x42f3,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    1000:	68 fc 42 00 00       	push   $0x42fc
    1005:	6a 01                	push   $0x1
    1007:	e8 44 2b 00 00       	call   3b50 <printf>
    ...
    101a:	68 b8 4f 00 00       	push   $0x4fb8
    101f:	6a 01                	push   $0x1
    1021:	e8 2a 2b 00 00       	call   3b50 <printf>
    return;
    ...
    1034:	68 04 50 00 00       	push   $0x5004
    1039:	6a 01                	push   $0x1
    103b:	e8 10 2b 00 00       	call   3b50 <printf>
    return;
    ...
    1050:	53                   	push   %ebx
    1051:	52                   	push   %edx
    1052:	68 09 43 00 00       	push   $0x4309
    1057:	6a 01                	push   $0x1
    1059:	e8 f2 2a 00 00       	call   3b50 <printf>
    exit();
...
00001070 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1079:	be 1e 43 00 00       	mov    $0x431e,%esi
{
    107e:	53                   	push   %ebx
  for(pi = 0; pi < 4; pi++){
    107f:	31 db                	xor    %ebx,%ebx
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1084:	c7 45 d8 1e 43 00 00 	movl   $0x431e,-0x28(%ebp)
  printf(1, "fourfiles test\n");
    108b:	68 24 43 00 00       	push   $0x4324
    1090:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1092:	c7 45 dc 67 44 00 00 	movl   $0x4467,-0x24(%ebp)
    1099:	c7 45 e0 6b 44 00 00 	movl   $0x446b,-0x20(%ebp)
    10a0:	c7 45 e4 21 43 00 00 	movl   $0x4321,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
    10a7:	e8 a4 2a 00 00       	call   3b50 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    117e:	68 62 43 00 00       	push   $0x4362
    1183:	6a 01                	push   $0x1
    1185:	e8 c6 29 00 00       	call   3b50 <printf>
}
    ...
    11a2:	68 45 43 00 00       	push   $0x4345
    11a7:	6a 01                	push   $0x1
    11a9:	e8 a2 29 00 00       	call   3b50 <printf>
          exit();
    ...
    120f:	51                   	push   %ecx
    1210:	51                   	push   %ecx
    1211:	68 bf 45 00 00       	push   $0x45bf
    1216:	6a 01                	push   $0x1
    1218:	e8 33 29 00 00       	call   3b50 <printf>
        exit();
    121d:	e8 61 27 00 00       	call   3983 <exit>
    1222:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      printf(1, "fork failed\n");
    1228:	83 ec 08             	sub    $0x8,%esp
    122b:	68 f9 4d 00 00       	push   $0x4df9
    1230:	6a 01                	push   $0x1
    1232:	e8 19 29 00 00       	call   3b50 <printf>
      exit();
    1237:	e8 47 27 00 00       	call   3983 <exit>
      printf(1, "wrong length %d\n", total);
    123c:	50                   	push   %eax
    123d:	53                   	push   %ebx
    123e:	68 51 43 00 00       	push   $0x4351
    1243:	6a 01                	push   $0x1
    1245:	e8 06 29 00 00       	call   3b50 <printf>
      exit();
    124a:	e8 34 27 00 00       	call   3983 <exit>
          printf(1, "write failed %d\n", n);
    124f:	52                   	push   %edx
    1250:	50                   	push   %eax
    1251:	68 34 43 00 00       	push   $0x4334
    1256:	6a 01                	push   $0x1
    1258:	e8 f3 28 00 00       	call   3b50 <printf>
          exit();
    ...
    127a:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    127f:	68 70 43 00 00       	push   $0x4370
    1284:	6a 01                	push   $0x1
    1286:	e8 c5 28 00 00       	call   3b50 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    1384:	68 83 43 00 00       	push   $0x4383
    1389:	6a 01                	push   $0x1
    138b:	e8 c0 27 00 00       	call   3b50 <printf>
}
    ...
    1422:	52                   	push   %edx
    1423:	52                   	push   %edx
    1424:	68 71 3f 00 00       	push   $0x3f71
    1429:	6a 01                	push   $0x1
    142b:	e8 20 27 00 00       	call   3b50 <printf>
            exit();
    ...
    1443:	57                   	push   %edi
    1444:	68 30 50 00 00       	push   $0x5030
    1449:	6a 01                	push   $0x1
    144b:	e8 00 27 00 00       	call   3b50 <printf>
        exit();
    1450:	e8 2e 25 00 00       	call   3983 <exit>
          printf(1, "create failed\n");
    1455:	83 ec 08             	sub    $0x8,%esp
    1458:	68 bf 45 00 00       	push   $0x45bf
    145d:	6a 01                	push   $0x1
    145f:	e8 ec 26 00 00       	call   3b50 <printf>
          exit();
    1464:	e8 1a 25 00 00       	call   3983 <exit>
      printf(1, "fork failed\n");
    1469:	83 ec 08             	sub    $0x8,%esp
    146c:	68 f9 4d 00 00       	push   $0x4df9
    1471:	6a 01                	push   $0x1
    1473:	e8 d8 26 00 00       	call   3b50 <printf>
      exit();
    ...
    1488:	50                   	push   %eax
    1489:	57                   	push   %edi
    148a:	68 54 50 00 00       	push   $0x5054
    148f:	6a 01                	push   $0x1
    1491:	e8 ba 26 00 00       	call   3b50 <printf>
        exit();
...
000014a0 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    14ac:	68 94 43 00 00       	push   $0x4394
    14b1:	6a 01                	push   $0x1
    14b3:	e8 98 26 00 00       	call   3b50 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    14b8:	5b                   	pop    %ebx
    14b9:	5e                   	pop    %esi
    14ba:	68 02 02 00 00       	push   $0x202
    14bf:	68 a5 43 00 00       	push   $0x43a5
  ...
  write(fd, "hello", 5);
    ...
    14d9:	6a 05                	push   $0x5
    14db:	68 ca 43 00 00       	push   $0x43ca
    14e0:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    14ef:	5a                   	pop    %edx
    14f0:	6a 02                	push   $0x2
    14f2:	68 a5 43 00 00       	push   $0x43a5
  ...
  if(unlink("unlinkread") != 0){
    ...
    150c:	68 a5 43 00 00       	push   $0x43a5
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1529:	68 a5 43 00 00       	push   $0x43a5
  ...
  write(fd1, "yyy", 3);
    153a:	68 02 44 00 00       	push   $0x4402
    153f:	50                   	push   %eax
  ...
  unlink("unlinkread");
    1596:	c7 04 24 a5 43 00 00 	movl   $0x43a5,(%esp)
    159d:	e8 31 24 00 00       	call   39d3 <unlink>
  printf(1, "unlinkread ok\n");
    15a2:	58                   	pop    %eax
    15a3:	5a                   	pop    %edx
    15a4:	68 4d 44 00 00       	push   $0x444d
    15a9:	6a 01                	push   $0x1
    15ab:	e8 a0 25 00 00       	call   3b50 <printf>
}
    ...
    15ba:	51                   	push   %ecx
    15bb:	51                   	push   %ecx
    15bc:	68 b0 43 00 00       	push   $0x43b0
    15c1:	6a 01                	push   $0x1
    15c3:	e8 88 25 00 00       	call   3b50 <printf>
    exit();
    15c8:	e8 b6 23 00 00       	call   3983 <exit>
    printf(1, "unlinkread write failed\n");
    15cd:	51                   	push   %ecx
    15ce:	51                   	push   %ecx
    15cf:	68 34 44 00 00       	push   $0x4434
    15d4:	6a 01                	push   $0x1
    15d6:	e8 75 25 00 00       	call   3b50 <printf>
    exit();
    15db:	e8 a3 23 00 00       	call   3983 <exit>
    printf(1, "unlinkread wrong data\n");
    15e0:	53                   	push   %ebx
    15e1:	53                   	push   %ebx
    15e2:	68 1d 44 00 00       	push   $0x441d
    15e7:	6a 01                	push   $0x1
    15e9:	e8 62 25 00 00       	call   3b50 <printf>
    exit();
    15ee:	e8 90 23 00 00       	call   3983 <exit>
    printf(1, "unlinkread read failed");
    15f3:	56                   	push   %esi
    15f4:	56                   	push   %esi
    15f5:	68 06 44 00 00       	push   $0x4406
    15fa:	6a 01                	push   $0x1
    15fc:	e8 4f 25 00 00       	call   3b50 <printf>
    exit();
    1601:	e8 7d 23 00 00       	call   3983 <exit>
    printf(1, "unlink unlinkread failed\n");
    1606:	50                   	push   %eax
    1607:	50                   	push   %eax
    1608:	68 e8 43 00 00       	push   $0x43e8
    160d:	6a 01                	push   $0x1
    160f:	e8 3c 25 00 00       	call   3b50 <printf>
    exit();
    1614:	e8 6a 23 00 00       	call   3983 <exit>
    printf(1, "open unlinkread failed\n");
    1619:	50                   	push   %eax
    161a:	50                   	push   %eax
    161b:	68 d0 43 00 00       	push   $0x43d0
    1620:	6a 01                	push   $0x1
    1622:	e8 29 25 00 00       	call   3b50 <printf>
    exit();
...
00001630 <linktest>:
{
  ...
  printf(1, "linktest\n");
    163b:	68 5c 44 00 00       	push   $0x445c
    1640:	6a 01                	push   $0x1
    1642:	e8 09 25 00 00       	call   3b50 <printf>
  unlink("lf1");
    1647:	c7 04 24 66 44 00 00 	movl   $0x4466,(%esp)
    164e:	e8 80 23 00 00       	call   39d3 <unlink>
  unlink("lf2");
    1653:	c7 04 24 6a 44 00 00 	movl   $0x446a,(%esp)
    165a:	e8 74 23 00 00       	call   39d3 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    165f:	58                   	pop    %eax
    1660:	5a                   	pop    %edx
    1661:	68 02 02 00 00       	push   $0x202
    1666:	68 66 44 00 00       	push   $0x4466
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1680:	6a 05                	push   $0x5
    1682:	68 ca 43 00 00       	push   $0x43ca
    1687:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    16a2:	5b                   	pop    %ebx
    16a3:	58                   	pop    %eax
    16a4:	68 6a 44 00 00       	push   $0x446a
    16a9:	68 66 44 00 00       	push   $0x4466
  ...
  unlink("lf1");
    ...
    16c1:	68 66 44 00 00       	push   $0x4466
    16c6:	e8 08 23 00 00       	call   39d3 <unlink>
  if(open("lf1", 0) >= 0){
    16cb:	58                   	pop    %eax
    16cc:	5a                   	pop    %edx
    16cd:	6a 00                	push   $0x0
    16cf:	68 66 44 00 00       	push   $0x4466
  ...
  fd = open("lf2", 0);
    ...
    16e7:	6a 00                	push   $0x0
    16e9:	68 6a 44 00 00       	push   $0x446a
  ...
  if(link("lf2", "lf2") >= 0){
    1728:	58                   	pop    %eax
    1729:	5a                   	pop    %edx
    172a:	68 6a 44 00 00       	push   $0x446a
    172f:	68 6a 44 00 00       	push   $0x446a
  ...
  unlink("lf2");
    ...
    1747:	68 6a 44 00 00       	push   $0x446a
    174c:	e8 82 22 00 00       	call   39d3 <unlink>
  if(link("lf2", "lf1") >= 0){
    1751:	59                   	pop    %ecx
    1752:	5b                   	pop    %ebx
    1753:	68 66 44 00 00       	push   $0x4466
    1758:	68 6a 44 00 00       	push   $0x446a
  ...
  if(link(".", "lf1") >= 0){
    ...
    176c:	68 66 44 00 00       	push   $0x4466
    1771:	68 2e 47 00 00       	push   $0x472e
  ...
  printf(1, "linktest ok\n");
    ...
    1785:	68 04 45 00 00       	push   $0x4504
    178a:	6a 01                	push   $0x1
    178c:	e8 bf 23 00 00       	call   3b50 <printf>
}
    ...
    1799:	50                   	push   %eax
    179a:	50                   	push   %eax
    179b:	68 6e 44 00 00       	push   $0x446e
    17a0:	6a 01                	push   $0x1
    17a2:	e8 a9 23 00 00       	call   3b50 <printf>
    exit();
    17a7:	e8 d7 21 00 00       	call   3983 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    17ac:	50                   	push   %eax
    17ad:	50                   	push   %eax
    17ae:	68 e8 44 00 00       	push   $0x44e8
    17b3:	6a 01                	push   $0x1
    17b5:	e8 96 23 00 00       	call   3b50 <printf>
    exit();
    17ba:	e8 c4 21 00 00       	call   3983 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    17bf:	52                   	push   %edx
    17c0:	52                   	push   %edx
    17c1:	68 9c 50 00 00       	push   $0x509c
    17c6:	6a 01                	push   $0x1
    17c8:	e8 83 23 00 00       	call   3b50 <printf>
    exit();
    17cd:	e8 b1 21 00 00       	call   3983 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    17d2:	50                   	push   %eax
    17d3:	50                   	push   %eax
    17d4:	68 ca 44 00 00       	push   $0x44ca
    17d9:	6a 01                	push   $0x1
    17db:	e8 70 23 00 00       	call   3b50 <printf>
    exit();
    17e0:	e8 9e 21 00 00       	call   3983 <exit>
    printf(1, "read lf2 failed\n");
    17e5:	51                   	push   %ecx
    17e6:	51                   	push   %ecx
    17e7:	68 b9 44 00 00       	push   $0x44b9
    17ec:	6a 01                	push   $0x1
    17ee:	e8 5d 23 00 00       	call   3b50 <printf>
    exit();
    17f3:	e8 8b 21 00 00       	call   3983 <exit>
    printf(1, "open lf2 failed\n");
    17f8:	53                   	push   %ebx
    17f9:	53                   	push   %ebx
    17fa:	68 a8 44 00 00       	push   $0x44a8
    17ff:	6a 01                	push   $0x1
    1801:	e8 4a 23 00 00       	call   3b50 <printf>
    exit();
    1806:	e8 78 21 00 00       	call   3983 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    180b:	50                   	push   %eax
    180c:	50                   	push   %eax
    180d:	68 74 50 00 00       	push   $0x5074
    1812:	6a 01                	push   $0x1
    1814:	e8 37 23 00 00       	call   3b50 <printf>
    exit();
    1819:	e8 65 21 00 00       	call   3983 <exit>
    printf(1, "link lf1 lf2 failed\n");
    181e:	51                   	push   %ecx
    181f:	51                   	push   %ecx
    1820:	68 93 44 00 00       	push   $0x4493
    1825:	6a 01                	push   $0x1
    1827:	e8 24 23 00 00       	call   3b50 <printf>
    exit();
    182c:	e8 52 21 00 00       	call   3983 <exit>
    printf(1, "write lf1 failed\n");
    1831:	50                   	push   %eax
    1832:	50                   	push   %eax
    1833:	68 81 44 00 00       	push   $0x4481
    1838:	6a 01                	push   $0x1
    183a:	e8 11 23 00 00       	call   3b50 <printf>
    exit();
    ...
    1859:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    1862:	68 11 45 00 00       	push   $0x4511
    1867:	6a 01                	push   $0x1
    1869:	e8 e2 22 00 00       	call   3b50 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1908:	53                   	push   %ebx
    1909:	68 24 45 00 00       	push   $0x4524
    190e:	6a 01                	push   $0x1
    1910:	e8 3b 22 00 00       	call   3b50 <printf>
        exit();
    ...
    1923:	53                   	push   %ebx
    1924:	68 21 45 00 00       	push   $0x4521
  ...
  for(i = 0; i < 40; i++){
    1943:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1946:	53                   	push   %ebx
    1947:	68 21 45 00 00       	push   $0x4521
  ...
  fd = open(".", 0);
    ...
    1973:	5f                   	pop    %edi
    1974:	6a 00                	push   $0x0
    1976:	68 2e 47 00 00       	push   $0x472e
  ...
  printf(1, "concreate ok\n");
    ...
    1ad3:	68 76 45 00 00       	push   $0x4576
    1ad8:	6a 01                	push   $0x1
    1ada:	e8 71 20 00 00       	call   3b50 <printf>
}
    ...
    1aea:	68 f9 4d 00 00       	push   $0x4df9
    1aef:	6a 01                	push   $0x1
    1af1:	e8 5a 20 00 00       	call   3b50 <printf>
      exit();
    1af6:	e8 88 1e 00 00       	call   3983 <exit>
    printf(1, "concreate not enough files in directory listing\n");
    1afb:	51                   	push   %ecx
    1afc:	51                   	push   %ecx
    1afd:	68 c0 50 00 00       	push   $0x50c0
    1b02:	6a 01                	push   $0x1
    1b04:	e8 47 20 00 00       	call   3b50 <printf>
    exit();
    ...
    1b14:	50                   	push   %eax
    1b15:	68 59 45 00 00       	push   $0x4559
    1b1a:	6a 01                	push   $0x1
    1b1c:	e8 2f 20 00 00       	call   3b50 <printf>
        exit();
    ...
    1b2c:	50                   	push   %eax
    1b2d:	68 40 45 00 00       	push   $0x4540
    1b32:	6a 01                	push   $0x1
    1b34:	e8 17 20 00 00       	call   3b50 <printf>
        exit();
...
00001b50 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1b5d:	68 84 45 00 00       	push   $0x4584
    1b62:	6a 01                	push   $0x1
    1b64:	e8 e7 1f 00 00       	call   3b50 <printf>
  unlink("x");
    1b69:	c7 04 24 11 48 00 00 	movl   $0x4811,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ba8:	68 11 48 00 00       	push   $0x4811
  ...
  for(i = 0; i < 100; i++){
    ...
    1be1:	68 11 48 00 00       	push   $0x4811
  ...
  printf(1, "linkunlink ok\n");
    ...
    1c0a:	68 99 45 00 00       	push   $0x4599
    1c0f:	6a 01                	push   $0x1
    1c11:	e8 3a 1f 00 00       	call   3b50 <printf>
}
    ...
    1c23:	68 11 48 00 00       	push   $0x4811
    1c28:	68 95 45 00 00       	push   $0x4595
    ...
    1c3a:	52                   	push   %edx
    1c3b:	52                   	push   %edx
    1c3c:	68 f9 4d 00 00       	push   $0x4df9
    1c41:	6a 01                	push   $0x1
    1c43:	e8 08 1f 00 00       	call   3b50 <printf>
    exit();
...
00001c60 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1c6d:	68 a8 45 00 00       	push   $0x45a8
    1c72:	6a 01                	push   $0x1
    1c74:	e8 d7 1e 00 00       	call   3b50 <printf>
  unlink("bd");
    1c79:	c7 04 24 b5 45 00 00 	movl   $0x45b5,(%esp)
    1c80:	e8 4e 1d 00 00       	call   39d3 <unlink>
  fd = open("bd", O_CREATE);
    1c85:	5a                   	pop    %edx
    1c86:	59                   	pop    %ecx
    1c87:	68 00 02 00 00       	push   $0x200
    1c8c:	68 b5 45 00 00       	push   $0x45b5
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1cc8:	68 b5 45 00 00       	push   $0x45b5
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1cfb:	68 b5 45 00 00       	push   $0x45b5
  ...
  printf(1, "bigdir ok\n");
    ...
    1d4c:	68 f7 45 00 00       	push   $0x45f7
    1d51:	6a 01                	push   $0x1
    1d53:	e8 f8 1d 00 00       	call   3b50 <printf>
    ...
    1d66:	68 ce 45 00 00       	push   $0x45ce
    1d6b:	6a 01                	push   $0x1
    1d6d:	e8 de 1d 00 00       	call   3b50 <printf>
      exit();
    1d72:	e8 0c 1c 00 00       	call   3983 <exit>
      printf(1, "bigdir unlink failed");
    1d77:	83 ec 08             	sub    $0x8,%esp
    1d7a:	68 e2 45 00 00       	push   $0x45e2
    1d7f:	6a 01                	push   $0x1
    1d81:	e8 ca 1d 00 00       	call   3b50 <printf>
      exit();
    1d86:	e8 f8 1b 00 00       	call   3983 <exit>
    printf(1, "bigdir create failed\n");
    1d8b:	50                   	push   %eax
    1d8c:	50                   	push   %eax
    1d8d:	68 b8 45 00 00       	push   $0x45b8
    1d92:	6a 01                	push   $0x1
    1d94:	e8 b7 1d 00 00       	call   3b50 <printf>
    exit();
...
00001da0 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1dab:	68 02 46 00 00       	push   $0x4602
    1db0:	6a 01                	push   $0x1
    1db2:	e8 99 1d 00 00       	call   3b50 <printf>
  unlink("ff");
    1db7:	c7 04 24 8b 46 00 00 	movl   $0x468b,(%esp)
    1dbe:	e8 10 1c 00 00       	call   39d3 <unlink>
  if(mkdir("dd") != 0){
    1dc3:	c7 04 24 28 47 00 00 	movl   $0x4728,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1de2:	68 61 46 00 00       	push   $0x4661
  ...
  write(fd, "ff", 2);
    ...
    1dfc:	6a 02                	push   $0x2
    1dfe:	68 8b 46 00 00       	push   $0x468b
    1e03:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1e11:	c7 04 24 28 47 00 00 	movl   $0x4728,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1e2b:	68 3c 46 00 00       	push   $0x463c
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1e48:	68 5e 46 00 00       	push   $0x465e
  ...
  write(fd, "FF", 2);
    ...
    1e62:	6a 02                	push   $0x2
    1e64:	68 7f 46 00 00       	push   $0x467f
    1e69:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e78:	5a                   	pop    %edx
    1e79:	6a 00                	push   $0x0
    1e7b:	68 82 46 00 00       	push   $0x4682
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1ec7:	59                   	pop    %ecx
    1ec8:	5b                   	pop    %ebx
    1ec9:	68 c2 46 00 00       	push   $0x46c2
    1ece:	68 5e 46 00 00       	push   $0x465e
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1ee6:	68 5e 46 00 00       	push   $0x465e
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1efe:	6a 00                	push   $0x0
    1f00:	68 5e 46 00 00       	push   $0x465e
  ...
  if(chdir("dd") != 0){
    ...
    1f18:	68 28 47 00 00       	push   $0x4728
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1f30:	68 f6 46 00 00       	push   $0x46f6
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f48:	68 1c 47 00 00       	push   $0x471c
  ...
  if(chdir("./..") != 0){
    ...
    1f60:	68 2b 47 00 00       	push   $0x472b
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f78:	6a 00                	push   $0x0
    1f7a:	68 c2 46 00 00       	push   $0x46c2
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1fba:	5a                   	pop    %edx
    1fbb:	6a 00                	push   $0x0
    1fbd:	68 5e 46 00 00       	push   $0x465e
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1fda:	68 76 47 00 00       	push   $0x4776
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1ff7:	68 9b 47 00 00       	push   $0x479b
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2014:	68 28 47 00 00       	push   $0x4728
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    202c:	6a 02                	push   $0x2
    202e:	68 28 47 00 00       	push   $0x4728
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2046:	6a 01                	push   $0x1
    2048:	68 28 47 00 00       	push   $0x4728
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2060:	68 0a 48 00 00       	push   $0x480a
    2065:	68 76 47 00 00       	push   $0x4776
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    207d:	68 0a 48 00 00       	push   $0x480a
    2082:	68 9b 47 00 00       	push   $0x479b
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    209a:	68 c2 46 00 00       	push   $0x46c2
    209f:	68 61 46 00 00       	push   $0x4661
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    20b7:	68 76 47 00 00       	push   $0x4776
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    20cf:	68 9b 47 00 00       	push   $0x479b
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    20e7:	68 c2 46 00 00       	push   $0x46c2
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    20ff:	68 9b 47 00 00       	push   $0x479b
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2117:	68 76 47 00 00       	push   $0x4776
  ...
  if(chdir("dd/ff") == 0){
    ...
    212f:	68 61 46 00 00       	push   $0x4661
  ...
  if(chdir("dd/xx") == 0){
    ...
    2147:	68 0d 48 00 00       	push   $0x480d
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    215f:	68 c2 46 00 00       	push   $0x46c2
  ...
  if(unlink("dd/ff") != 0){
    ...
    2177:	68 61 46 00 00       	push   $0x4661
  ...
  if(unlink("dd") == 0){
    ...
    218f:	68 28 47 00 00       	push   $0x4728
  ...
  if(unlink("dd/dd") < 0){
    ...
    21a7:	68 3d 46 00 00       	push   $0x463d
  ...
  if(unlink("dd") < 0){
    ...
    21bf:	68 28 47 00 00       	push   $0x4728
  ...
  printf(1, "subdir ok\n");
    ...
    21d7:	68 0a 49 00 00       	push   $0x490a
    21dc:	6a 01                	push   $0x1
    21de:	e8 6d 19 00 00       	call   3b50 <printf>
}
    ...
    21eb:	50                   	push   %eax
    21ec:	50                   	push   %eax
    21ed:	68 a7 46 00 00       	push   $0x46a7
    21f2:	6a 01                	push   $0x1
    21f4:	e8 57 19 00 00       	call   3b50 <printf>
    exit();
    21f9:	e8 85 17 00 00       	call   3983 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    21fe:	50                   	push   %eax
    21ff:	50                   	push   %eax
    2200:	68 02 47 00 00       	push   $0x4702
    2205:	6a 01                	push   $0x1
    2207:	e8 44 19 00 00       	call   3b50 <printf>
    exit();
    220c:	e8 72 17 00 00       	call   3983 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    2211:	50                   	push   %eax
    2212:	50                   	push   %eax
    2213:	68 cd 46 00 00       	push   $0x46cd
    2218:	6a 01                	push   $0x1
    221a:	e8 31 19 00 00       	call   3b50 <printf>
    exit();
    221f:	e8 5f 17 00 00       	call   3983 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    2224:	51                   	push   %ecx
    2225:	51                   	push   %ecx
    2226:	68 7f 47 00 00       	push   $0x477f
    222b:	6a 01                	push   $0x1
    222d:	e8 1e 19 00 00       	call   3b50 <printf>
    exit();
    2232:	e8 4c 17 00 00       	call   3983 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2237:	53                   	push   %ebx
    2238:	53                   	push   %ebx
    2239:	68 64 51 00 00       	push   $0x5164
    223e:	6a 01                	push   $0x1
    2240:	e8 0b 19 00 00       	call   3b50 <printf>
    exit();
    2245:	e8 39 17 00 00       	call   3983 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    224a:	51                   	push   %ecx
    224b:	51                   	push   %ecx
    224c:	68 13 48 00 00       	push   $0x4813
    2251:	6a 01                	push   $0x1
    2253:	e8 f8 18 00 00       	call   3b50 <printf>
    exit();
    2258:	e8 26 17 00 00       	call   3983 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    225d:	53                   	push   %ebx
    225e:	53                   	push   %ebx
    225f:	68 d4 51 00 00       	push   $0x51d4
    2264:	6a 01                	push   $0x1
    2266:	e8 e5 18 00 00       	call   3b50 <printf>
    exit();
    226b:	e8 13 17 00 00       	call   3983 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    2270:	50                   	push   %eax
    2271:	50                   	push   %eax
    2272:	68 8e 46 00 00       	push   $0x468e
    2277:	6a 01                	push   $0x1
    2279:	e8 d2 18 00 00       	call   3b50 <printf>
    exit();
    227e:	e8 00 17 00 00       	call   3983 <exit>
    printf(1, "create dd/dd/ff failed\n");
    2283:	51                   	push   %ecx
    2284:	51                   	push   %ecx
    2285:	68 67 46 00 00       	push   $0x4667
    228a:	6a 01                	push   $0x1
    228c:	e8 bf 18 00 00       	call   3b50 <printf>
    exit();
    2291:	e8 ed 16 00 00       	call   3983 <exit>
    printf(1, "chdir ./.. failed\n");
    2296:	50                   	push   %eax
    2297:	50                   	push   %eax
    2298:	68 30 47 00 00       	push   $0x4730
    229d:	6a 01                	push   $0x1
    229f:	e8 ac 18 00 00       	call   3b50 <printf>
    exit();
    22a4:	e8 da 16 00 00       	call   3983 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    22a9:	52                   	push   %edx
    22aa:	52                   	push   %edx
    22ab:	68 1c 51 00 00       	push   $0x511c
    22b0:	6a 01                	push   $0x1
    22b2:	e8 99 18 00 00       	call   3b50 <printf>
    exit();
    22b7:	e8 c7 16 00 00       	call   3983 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    22bc:	50                   	push   %eax
    22bd:	50                   	push   %eax
    22be:	68 b0 51 00 00       	push   $0x51b0
    22c3:	6a 01                	push   $0x1
    22c5:	e8 86 18 00 00       	call   3b50 <printf>
    exit();
    22ca:	e8 b4 16 00 00       	call   3983 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    22cf:	50                   	push   %eax
    22d0:	50                   	push   %eax
    22d1:	68 8c 51 00 00       	push   $0x518c
    22d6:	6a 01                	push   $0x1
    22d8:	e8 73 18 00 00       	call   3b50 <printf>
    exit();
    22dd:	e8 a1 16 00 00       	call   3983 <exit>
    printf(1, "open dd wronly succeeded!\n");
    22e2:	50                   	push   %eax
    22e3:	50                   	push   %eax
    22e4:	68 ef 47 00 00       	push   $0x47ef
    22e9:	6a 01                	push   $0x1
    22eb:	e8 60 18 00 00       	call   3b50 <printf>
    exit();
    22f0:	e8 8e 16 00 00       	call   3983 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    22f5:	50                   	push   %eax
    22f6:	50                   	push   %eax
    22f7:	68 d6 47 00 00       	push   $0x47d6
    22fc:	6a 01                	push   $0x1
    22fe:	e8 4d 18 00 00       	call   3b50 <printf>
    exit();
    2303:	e8 7b 16 00 00       	call   3983 <exit>
    printf(1, "create dd succeeded!\n");
    2308:	50                   	push   %eax
    2309:	50                   	push   %eax
    230a:	68 c0 47 00 00       	push   $0x47c0
    230f:	6a 01                	push   $0x1
    2311:	e8 3a 18 00 00       	call   3b50 <printf>
    exit();
    2316:	e8 68 16 00 00       	call   3983 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    231b:	52                   	push   %edx
    231c:	52                   	push   %edx
    231d:	68 a4 47 00 00       	push   $0x47a4
    2322:	6a 01                	push   $0x1
    2324:	e8 27 18 00 00       	call   3b50 <printf>
    exit();
    2329:	e8 55 16 00 00       	call   3983 <exit>
    printf(1, "chdir dd failed\n");
    232e:	50                   	push   %eax
    232f:	50                   	push   %eax
    2330:	68 e5 46 00 00       	push   $0x46e5
    2335:	6a 01                	push   $0x1
    2337:	e8 14 18 00 00       	call   3b50 <printf>
    exit();
    233c:	e8 42 16 00 00       	call   3983 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    2341:	50                   	push   %eax
    2342:	50                   	push   %eax
    2343:	68 40 51 00 00       	push   $0x5140
    2348:	6a 01                	push   $0x1
    234a:	e8 01 18 00 00       	call   3b50 <printf>
    exit();
    234f:	e8 2f 16 00 00       	call   3983 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    2354:	53                   	push   %ebx
    2355:	53                   	push   %ebx
    2356:	68 43 46 00 00       	push   $0x4643
    235b:	6a 01                	push   $0x1
    235d:	e8 ee 17 00 00       	call   3b50 <printf>
    exit();
    2362:	e8 1c 16 00 00       	call   3983 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    2367:	50                   	push   %eax
    2368:	50                   	push   %eax
    2369:	68 f4 50 00 00       	push   $0x50f4
    236e:	6a 01                	push   $0x1
    2370:	e8 db 17 00 00       	call   3b50 <printf>
    exit();
    2375:	e8 09 16 00 00       	call   3983 <exit>
    printf(1, "create dd/ff failed\n");
    237a:	50                   	push   %eax
    237b:	50                   	push   %eax
    237c:	68 27 46 00 00       	push   $0x4627
    2381:	6a 01                	push   $0x1
    2383:	e8 c8 17 00 00       	call   3b50 <printf>
    exit();
    2388:	e8 f6 15 00 00       	call   3983 <exit>
    printf(1, "subdir mkdir dd failed\n");
    238d:	50                   	push   %eax
    238e:	50                   	push   %eax
    238f:	68 0f 46 00 00       	push   $0x460f
    2394:	6a 01                	push   $0x1
    2396:	e8 b5 17 00 00       	call   3b50 <printf>
    exit();
    239b:	e8 e3 15 00 00       	call   3983 <exit>
    printf(1, "unlink dd failed\n");
    23a0:	50                   	push   %eax
    23a1:	50                   	push   %eax
    23a2:	68 f8 48 00 00       	push   $0x48f8
    23a7:	6a 01                	push   $0x1
    23a9:	e8 a2 17 00 00       	call   3b50 <printf>
    exit();
    23ae:	e8 d0 15 00 00       	call   3983 <exit>
    printf(1, "unlink dd/dd failed\n");
    23b3:	52                   	push   %edx
    23b4:	52                   	push   %edx
    23b5:	68 e3 48 00 00       	push   $0x48e3
    23ba:	6a 01                	push   $0x1
    23bc:	e8 8f 17 00 00       	call   3b50 <printf>
    exit();
    23c1:	e8 bd 15 00 00       	call   3983 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    23c6:	51                   	push   %ecx
    23c7:	51                   	push   %ecx
    23c8:	68 f8 51 00 00       	push   $0x51f8
    23cd:	6a 01                	push   $0x1
    23cf:	e8 7c 17 00 00       	call   3b50 <printf>
    exit();
    23d4:	e8 aa 15 00 00       	call   3983 <exit>
    printf(1, "unlink dd/ff failed\n");
    23d9:	53                   	push   %ebx
    23da:	53                   	push   %ebx
    23db:	68 ce 48 00 00       	push   $0x48ce
    23e0:	6a 01                	push   $0x1
    23e2:	e8 69 17 00 00       	call   3b50 <printf>
    exit();
    23e7:	e8 97 15 00 00       	call   3983 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    23ec:	50                   	push   %eax
    23ed:	50                   	push   %eax
    23ee:	68 b6 48 00 00       	push   $0x48b6
    23f3:	6a 01                	push   $0x1
    23f5:	e8 56 17 00 00       	call   3b50 <printf>
    exit();
    23fa:	e8 84 15 00 00       	call   3983 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    23ff:	50                   	push   %eax
    2400:	50                   	push   %eax
    2401:	68 9e 48 00 00       	push   $0x489e
    2406:	6a 01                	push   $0x1
    2408:	e8 43 17 00 00       	call   3b50 <printf>
    exit();
    240d:	e8 71 15 00 00       	call   3983 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    2412:	50                   	push   %eax
    2413:	50                   	push   %eax
    2414:	68 82 48 00 00       	push   $0x4882
    2419:	6a 01                	push   $0x1
    241b:	e8 30 17 00 00       	call   3b50 <printf>
    exit();
    2420:	e8 5e 15 00 00       	call   3983 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2425:	50                   	push   %eax
    2426:	50                   	push   %eax
    2427:	68 66 48 00 00       	push   $0x4866
    242c:	6a 01                	push   $0x1
    242e:	e8 1d 17 00 00       	call   3b50 <printf>
    exit();
    2433:	e8 4b 15 00 00       	call   3983 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2438:	50                   	push   %eax
    2439:	50                   	push   %eax
    243a:	68 49 48 00 00       	push   $0x4849
    243f:	6a 01                	push   $0x1
    2441:	e8 0a 17 00 00       	call   3b50 <printf>
    exit();
    ...
    2452:	6a 01                	push   $0x1
    2454:	e8 f7 16 00 00       	call   3b50 <printf>
    exit();
    2459:	e8 25 15 00 00       	call   3983 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    245e:	51                   	push   %ecx
    245f:	51                   	push   %ecx
    2460:	68 5b 47 00 00       	push   $0x475b
    2465:	6a 01                	push   $0x1
    2467:	e8 e4 16 00 00       	call   3b50 <printf>
    exit();
    246c:	e8 12 15 00 00       	call   3983 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    2471:	53                   	push   %ebx
    2472:	53                   	push   %ebx
    2473:	68 43 47 00 00       	push   $0x4743
    2478:	6a 01                	push   $0x1
    247a:	e8 d1 16 00 00       	call   3b50 <printf>
    exit();
...
00002490 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    24a1:	68 15 49 00 00       	push   $0x4915
    24a6:	6a 01                	push   $0x1
    24a8:	e8 a3 16 00 00       	call   3b50 <printf>
  unlink("bigwrite");
    24ad:	c7 04 24 24 49 00 00 	movl   $0x4924,(%esp)
    ...
    24c8:	68 24 49 00 00       	push   $0x4924
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2516:	c7 04 24 24 49 00 00 	movl   $0x4924,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2530:	68 57 49 00 00       	push   $0x4957
    2535:	6a 01                	push   $0x1
    2537:	e8 14 16 00 00       	call   3b50 <printf>
}
    ...
    2546:	50                   	push   %eax
    2547:	53                   	push   %ebx
    2548:	68 45 49 00 00       	push   $0x4945
    254d:	6a 01                	push   $0x1
    254f:	e8 fc 15 00 00       	call   3b50 <printf>
        exit();
    2554:	e8 2a 14 00 00       	call   3983 <exit>
      printf(1, "cannot create bigwrite\n");
    2559:	83 ec 08             	sub    $0x8,%esp
    255c:	68 2d 49 00 00       	push   $0x492d
    2561:	6a 01                	push   $0x1
    2563:	e8 e8 15 00 00       	call   3b50 <printf>
      exit();
...
00002570 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    257d:	68 64 49 00 00       	push   $0x4964
    2582:	6a 01                	push   $0x1
    2584:	e8 c7 15 00 00       	call   3b50 <printf>
  unlink("bigfile");
    2589:	c7 04 24 80 49 00 00 	movl   $0x4980,(%esp)
    2590:	e8 3e 14 00 00       	call   39d3 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2595:	58                   	pop    %eax
    2596:	5a                   	pop    %edx
    2597:	68 02 02 00 00       	push   $0x202
    259c:	68 80 49 00 00       	push   $0x4980
  ...
  fd = open("bigfile", 0);
    ...
    25fe:	5f                   	pop    %edi
    25ff:	6a 00                	push   $0x0
    2601:	68 80 49 00 00       	push   $0x4980
  ...
  unlink("bigfile");
    ...
    2685:	68 80 49 00 00       	push   $0x4980
    268a:	e8 44 13 00 00       	call   39d3 <unlink>
  printf(1, "bigfile test ok\n");
    268f:	58                   	pop    %eax
    2690:	5a                   	pop    %edx
    2691:	68 0f 4a 00 00       	push   $0x4a0f
    2696:	6a 01                	push   $0x1
    2698:	e8 b3 14 00 00       	call   3b50 <printf>
}
    ...
    26ab:	68 dc 49 00 00       	push   $0x49dc
    26b0:	6a 01                	push   $0x1
    26b2:	e8 99 14 00 00       	call   3b50 <printf>
      exit();
    26b7:	e8 c7 12 00 00       	call   3983 <exit>
      printf(1, "short read bigfile\n");
    26bc:	83 ec 08             	sub    $0x8,%esp
    26bf:	68 c8 49 00 00       	push   $0x49c8
    26c4:	6a 01                	push   $0x1
    26c6:	e8 85 14 00 00       	call   3b50 <printf>
      exit();
    26cb:	e8 b3 12 00 00       	call   3983 <exit>
      printf(1, "read bigfile failed\n");
    26d0:	83 ec 08             	sub    $0x8,%esp
    26d3:	68 b3 49 00 00       	push   $0x49b3
    26d8:	6a 01                	push   $0x1
    26da:	e8 71 14 00 00       	call   3b50 <printf>
      exit();
    26df:	e8 9f 12 00 00       	call   3983 <exit>
      printf(1, "write bigfile failed\n");
    26e4:	83 ec 08             	sub    $0x8,%esp
    26e7:	68 88 49 00 00       	push   $0x4988
    26ec:	6a 01                	push   $0x1
    26ee:	e8 5d 14 00 00       	call   3b50 <printf>
      exit();
    26f3:	e8 8b 12 00 00       	call   3983 <exit>
    printf(1, "cannot open bigfile\n");
    26f8:	53                   	push   %ebx
    26f9:	53                   	push   %ebx
    26fa:	68 9e 49 00 00       	push   $0x499e
    26ff:	6a 01                	push   $0x1
    2701:	e8 4a 14 00 00       	call   3b50 <printf>
    exit();
    2706:	e8 78 12 00 00       	call   3983 <exit>
    printf(1, "cannot create bigfile");
    270b:	50                   	push   %eax
    270c:	50                   	push   %eax
    270d:	68 72 49 00 00       	push   $0x4972
    2712:	6a 01                	push   $0x1
    2714:	e8 37 14 00 00       	call   3b50 <printf>
    exit();
    2719:	e8 65 12 00 00       	call   3983 <exit>
    printf(1, "read bigfile wrong total\n");
    271e:	51                   	push   %ecx
    271f:	51                   	push   %ecx
    2720:	68 f5 49 00 00       	push   $0x49f5
    2725:	6a 01                	push   $0x1
    2727:	e8 24 14 00 00       	call   3b50 <printf>
    exit();
...
00002740 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    274a:	68 20 4a 00 00       	push   $0x4a20
    274f:	6a 01                	push   $0x1
    2751:	e8 fa 13 00 00       	call   3b50 <printf>
  if(mkdir("12345678901234") != 0){
    2756:	c7 04 24 5b 4a 00 00 	movl   $0x4a5b,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2770:	68 18 52 00 00       	push   $0x5218
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    278d:	68 68 52 00 00       	push   $0x5268
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27ac:	5a                   	pop    %edx
    27ad:	6a 00                	push   $0x0
    27af:	68 d8 52 00 00       	push   $0x52d8
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    27c9:	c7 04 24 4c 4a 00 00 	movl   $0x4a4c,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    27df:	68 74 53 00 00       	push   $0x5374
  ...
  printf(1, "fourteen ok\n");
    ...
    27f3:	68 6a 4a 00 00       	push   $0x4a6a
    27f8:	6a 01                	push   $0x1
    27fa:	e8 51 13 00 00       	call   3b50 <printf>
}
    ...
    2804:	50                   	push   %eax
    2805:	50                   	push   %eax
    2806:	68 2f 4a 00 00       	push   $0x4a2f
    280b:	6a 01                	push   $0x1
    280d:	e8 3e 13 00 00       	call   3b50 <printf>
    exit();
    2812:	e8 6c 11 00 00       	call   3983 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    2817:	50                   	push   %eax
    2818:	50                   	push   %eax
    2819:	68 94 53 00 00       	push   $0x5394
    281e:	6a 01                	push   $0x1
    2820:	e8 2b 13 00 00       	call   3b50 <printf>
    exit();
    2825:	e8 59 11 00 00       	call   3983 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    282a:	52                   	push   %edx
    282b:	52                   	push   %edx
    282c:	68 44 53 00 00       	push   $0x5344
    2831:	6a 01                	push   $0x1
    2833:	e8 18 13 00 00       	call   3b50 <printf>
    exit();
    2838:	e8 46 11 00 00       	call   3983 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    283d:	51                   	push   %ecx
    283e:	51                   	push   %ecx
    283f:	68 08 53 00 00       	push   $0x5308
    2844:	6a 01                	push   $0x1
    2846:	e8 05 13 00 00       	call   3b50 <printf>
    exit();
    284b:	e8 33 11 00 00       	call   3983 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    2850:	51                   	push   %ecx
    2851:	51                   	push   %ecx
    2852:	68 98 52 00 00       	push   $0x5298
    2857:	6a 01                	push   $0x1
    2859:	e8 f2 12 00 00       	call   3b50 <printf>
    exit();
    285e:	e8 20 11 00 00       	call   3983 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2863:	50                   	push   %eax
    2864:	50                   	push   %eax
    2865:	68 38 52 00 00       	push   $0x5238
    286a:	6a 01                	push   $0x1
    286c:	e8 df 12 00 00       	call   3b50 <printf>
    exit();
...
00002880 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    288a:	68 77 4a 00 00       	push   $0x4a77
    288f:	6a 01                	push   $0x1
    2891:	e8 ba 12 00 00       	call   3b50 <printf>
  if(mkdir("dots") != 0){
    2896:	c7 04 24 83 4a 00 00 	movl   $0x4a83,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    28b0:	68 83 4a 00 00       	push   $0x4a83
  ...
  if(unlink(".") == 0){
    ...
    28c8:	68 2e 47 00 00       	push   $0x472e
  ...
  if(unlink("..") == 0){
    ...
    28e0:	68 2d 47 00 00       	push   $0x472d
  ...
  if(chdir("/") != 0){
    ...
    28f8:	68 01 3f 00 00       	push   $0x3f01
  ...
  if(unlink("dots/.") == 0){
    ...
    2910:	68 cb 4a 00 00       	push   $0x4acb
  ...
  if(unlink("dots/..") == 0){
    ...
    2924:	68 e9 4a 00 00       	push   $0x4ae9
  ...
  if(unlink("dots") != 0){
    ...
    2938:	68 83 4a 00 00       	push   $0x4a83
  ...
  printf(1, "rmdot ok\n");
    ...
    294c:	68 1e 4b 00 00       	push   $0x4b1e
    2951:	6a 01                	push   $0x1
    2953:	e8 f8 11 00 00       	call   3b50 <printf>
}
    ...
    295d:	50                   	push   %eax
    295e:	50                   	push   %eax
    295f:	68 88 4a 00 00       	push   $0x4a88
    2964:	6a 01                	push   $0x1
    2966:	e8 e5 11 00 00       	call   3b50 <printf>
    exit();
    296b:	e8 13 10 00 00       	call   3983 <exit>
    printf(1, "unlink dots failed!\n");
    2970:	50                   	push   %eax
    2971:	50                   	push   %eax
    2972:	68 09 4b 00 00       	push   $0x4b09
    2977:	6a 01                	push   $0x1
    2979:	e8 d2 11 00 00       	call   3b50 <printf>
    exit();
    297e:	e8 00 10 00 00       	call   3983 <exit>
    printf(1, "unlink dots/.. worked!\n");
    2983:	52                   	push   %edx
    2984:	52                   	push   %edx
    2985:	68 f1 4a 00 00       	push   $0x4af1
    298a:	6a 01                	push   $0x1
    298c:	e8 bf 11 00 00       	call   3b50 <printf>
    exit();
    2991:	e8 ed 0f 00 00       	call   3983 <exit>
    printf(1, "unlink dots/. worked!\n");
    2996:	51                   	push   %ecx
    2997:	51                   	push   %ecx
    2998:	68 d2 4a 00 00       	push   $0x4ad2
    299d:	6a 01                	push   $0x1
    299f:	e8 ac 11 00 00       	call   3b50 <printf>
    exit();
    29a4:	e8 da 0f 00 00       	call   3983 <exit>
    printf(1, "chdir / failed\n");
    29a9:	50                   	push   %eax
    29aa:	50                   	push   %eax
    29ab:	68 03 3f 00 00       	push   $0x3f03
    29b0:	6a 01                	push   $0x1
    29b2:	e8 99 11 00 00       	call   3b50 <printf>
    exit();
    29b7:	e8 c7 0f 00 00       	call   3983 <exit>
    printf(1, "rm .. worked!\n");
    29bc:	50                   	push   %eax
    29bd:	50                   	push   %eax
    29be:	68 bc 4a 00 00       	push   $0x4abc
    29c3:	6a 01                	push   $0x1
    29c5:	e8 86 11 00 00       	call   3b50 <printf>
    exit();
    29ca:	e8 b4 0f 00 00       	call   3983 <exit>
    printf(1, "rm . worked!\n");
    29cf:	50                   	push   %eax
    29d0:	50                   	push   %eax
    29d1:	68 ae 4a 00 00       	push   $0x4aae
    29d6:	6a 01                	push   $0x1
    29d8:	e8 73 11 00 00       	call   3b50 <printf>
    exit();
    29dd:	e8 a1 0f 00 00       	call   3983 <exit>
    printf(1, "chdir dots failed\n");
    29e2:	50                   	push   %eax
    29e3:	50                   	push   %eax
    29e4:	68 9b 4a 00 00       	push   $0x4a9b
    29e9:	6a 01                	push   $0x1
    29eb:	e8 60 11 00 00       	call   3b50 <printf>
    exit();
...
00002a00 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2a0b:	68 28 4b 00 00       	push   $0x4b28
    2a10:	6a 01                	push   $0x1
    2a12:	e8 39 11 00 00       	call   3b50 <printf>
  fd = open("dirfile", O_CREATE);
    2a17:	5b                   	pop    %ebx
    2a18:	58                   	pop    %eax
    2a19:	68 00 02 00 00       	push   $0x200
    2a1e:	68 35 4b 00 00       	push   $0x4b35
  ...
  if(chdir("dirfile") == 0){
    2a3c:	c7 04 24 35 4b 00 00 	movl   $0x4b35,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a56:	6a 00                	push   $0x0
    2a58:	68 6e 4b 00 00       	push   $0x4b6e
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2a75:	68 6e 4b 00 00       	push   $0x4b6e
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2a8d:	68 6e 4b 00 00       	push   $0x4b6e
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2aa5:	68 6e 4b 00 00       	push   $0x4b6e
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2abd:	68 6e 4b 00 00       	push   $0x4b6e
    2ac2:	68 d2 4b 00 00       	push   $0x4bd2
  ...
  if(unlink("dirfile") != 0){
    ...
    2ada:	68 35 4b 00 00       	push   $0x4b35
  ...
  fd = open(".", O_RDWR);
    ...
    2af2:	6a 02                	push   $0x2
    2af4:	68 2e 47 00 00       	push   $0x472e
  ...
  fd = open(".", 0);
    ...
    2b0c:	6a 00                	push   $0x0
    2b0e:	68 2e 47 00 00       	push   $0x472e
  ...
  if(write(fd, "x", 1) > 0){
    2b1f:	68 11 48 00 00       	push   $0x4811
    2b24:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2b3a:	58                   	pop    %eax
    2b3b:	5a                   	pop    %edx
    2b3c:	68 05 4c 00 00       	push   $0x4c05
    2b41:	6a 01                	push   $0x1
    2b43:	e8 08 10 00 00       	call   3b50 <printf>
}
    ...
    2b50:	50                   	push   %eax
    2b51:	50                   	push   %eax
    2b52:	68 79 4b 00 00       	push   $0x4b79
    2b57:	6a 01                	push   $0x1
    2b59:	e8 f2 0f 00 00       	call   3b50 <printf>
    exit();
    2b5e:	e8 20 0e 00 00       	call   3983 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    2b63:	52                   	push   %edx
    2b64:	52                   	push   %edx
    2b65:	68 54 4b 00 00       	push   $0x4b54
    2b6a:	6a 01                	push   $0x1
    2b6c:	e8 df 0f 00 00       	call   3b50 <printf>
    exit();
    2b71:	e8 0d 0e 00 00       	call   3983 <exit>
    printf(1, "create dirfile failed\n");
    2b76:	51                   	push   %ecx
    2b77:	51                   	push   %ecx
    2b78:	68 3d 4b 00 00       	push   $0x4b3d
    2b7d:	6a 01                	push   $0x1
    2b7f:	e8 cc 0f 00 00       	call   3b50 <printf>
    exit();
    2b84:	e8 fa 0d 00 00       	call   3983 <exit>
    printf(1, "write . succeeded!\n");
    2b89:	51                   	push   %ecx
    2b8a:	51                   	push   %ecx
    2b8b:	68 f1 4b 00 00       	push   $0x4bf1
    2b90:	6a 01                	push   $0x1
    2b92:	e8 b9 0f 00 00       	call   3b50 <printf>
    exit();
    2b97:	e8 e7 0d 00 00       	call   3983 <exit>
    printf(1, "open . for writing succeeded!\n");
    2b9c:	53                   	push   %ebx
    2b9d:	53                   	push   %ebx
    2b9e:	68 e8 53 00 00       	push   $0x53e8
    2ba3:	6a 01                	push   $0x1
    2ba5:	e8 a6 0f 00 00       	call   3b50 <printf>
    exit();
    2baa:	e8 d4 0d 00 00       	call   3983 <exit>
    printf(1, "unlink dirfile failed!\n");
    2baf:	50                   	push   %eax
    2bb0:	50                   	push   %eax
    2bb1:	68 d9 4b 00 00       	push   $0x4bd9
    2bb6:	6a 01                	push   $0x1
    2bb8:	e8 93 0f 00 00       	call   3b50 <printf>
    exit();
    2bbd:	e8 c1 0d 00 00       	call   3983 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2bc2:	50                   	push   %eax
    2bc3:	50                   	push   %eax
    2bc4:	68 c8 53 00 00       	push   $0x53c8
    2bc9:	6a 01                	push   $0x1
    2bcb:	e8 80 0f 00 00       	call   3b50 <printf>
    exit();
    2bd0:	e8 ae 0d 00 00       	call   3983 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    2bd5:	50                   	push   %eax
    2bd6:	50                   	push   %eax
    2bd7:	68 b4 4b 00 00       	push   $0x4bb4
    2bdc:	6a 01                	push   $0x1
    2bde:	e8 6d 0f 00 00       	call   3b50 <printf>
    exit();
    2be3:	e8 9b 0d 00 00       	call   3983 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2be8:	50                   	push   %eax
    2be9:	50                   	push   %eax
    2bea:	68 97 4b 00 00       	push   $0x4b97
    2bef:	6a 01                	push   $0x1
    2bf1:	e8 5a 0f 00 00       	call   3b50 <printf>
    exit();
    ...
    2c08:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2c10:	68 15 4c 00 00       	push   $0x4c15
    2c15:	6a 01                	push   $0x1
    2c17:	e8 34 0f 00 00       	call   3b50 <printf>
    2c1c:	83 c4 10             	add    $0x10,%esp
    2c1f:	90                   	nop
    if(mkdir("irefd") != 0){
    2c20:	83 ec 0c             	sub    $0xc,%esp
    2c23:	68 26 4c 00 00       	push   $0x4c26
    ...
    2c3b:	68 26 4c 00 00       	push   $0x4c26
    ...
    2c53:	68 db 42 00 00       	push   $0x42db
    2c58:	e8 8e 0d 00 00       	call   39eb <mkdir>
    link("README", "");
    2c5d:	59                   	pop    %ecx
    2c5e:	58                   	pop    %eax
    2c5f:	68 db 42 00 00       	push   $0x42db
    2c64:	68 d2 4b 00 00       	push   $0x4bd2
    2c69:	e8 75 0d 00 00       	call   39e3 <link>
    fd = open("", O_CREATE);
    2c6e:	58                   	pop    %eax
    2c6f:	5a                   	pop    %edx
    2c70:	68 00 02 00 00       	push   $0x200
    2c75:	68 db 42 00 00       	push   $0x42db
    ...
    2c9a:	68 10 48 00 00       	push   $0x4810
    ...
    2cba:	68 10 48 00 00       	push   $0x4810
  ...
  chdir("/");
    ...
    2cd3:	68 01 3f 00 00       	push   $0x3f01
    2cd8:	e8 16 0d 00 00       	call   39f3 <chdir>
  printf(1, "empty file name OK\n");
    2cdd:	58                   	pop    %eax
    2cde:	5a                   	pop    %edx
    2cdf:	68 54 4c 00 00       	push   $0x4c54
    2ce4:	6a 01                	push   $0x1
    2ce6:	e8 65 0e 00 00       	call   3b50 <printf>
}
    ...
    2cf6:	68 2c 4c 00 00       	push   $0x4c2c
    2cfb:	6a 01                	push   $0x1
    2cfd:	e8 4e 0e 00 00       	call   3b50 <printf>
      exit();
    2d02:	e8 7c 0c 00 00       	call   3983 <exit>
      printf(1, "chdir irefd failed\n");
    2d07:	83 ec 08             	sub    $0x8,%esp
    2d0a:	68 40 4c 00 00       	push   $0x4c40
    2d0f:	6a 01                	push   $0x1
    2d11:	e8 3a 0e 00 00       	call   3b50 <printf>
      exit();
    ...
    2d28:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2d2d:	68 68 4c 00 00       	push   $0x4c68
    2d32:	6a 01                	push   $0x1
    2d34:	e8 17 0e 00 00       	call   3b50 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    2d7b:	68 9a 4c 00 00       	push   $0x4c9a
    2d80:	6a 01                	push   $0x1
    2d82:	e8 c9 0d 00 00       	call   3b50 <printf>
}
    ...
    2d94:	68 73 4c 00 00       	push   $0x4c73
    2d99:	6a 01                	push   $0x1
    2d9b:	e8 b0 0d 00 00       	call   3b50 <printf>
      exit();
    2da0:	e8 de 0b 00 00       	call   3983 <exit>
    printf(1, "wait got too many\n");
    2da5:	52                   	push   %edx
    2da6:	52                   	push   %edx
    2da7:	68 87 4c 00 00       	push   $0x4c87
    2dac:	6a 01                	push   $0x1
    2dae:	e8 9d 0d 00 00       	call   3b50 <printf>
    exit();
    2db3:	e8 cb 0b 00 00       	call   3983 <exit>
    printf(1, "fork claimed to work 1000 times!\n");
    2db8:	50                   	push   %eax
    2db9:	50                   	push   %eax
    2dba:	68 08 54 00 00       	push   $0x5408
    2dbf:	6a 01                	push   $0x1
    2dc1:	e8 8a 0d 00 00       	call   3b50 <printf>
    exit();
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2ddf:	68 a8 4c 00 00       	push   $0x4ca8
    2de4:	ff 35 50 5f 00 00    	pushl  0x5f50
    2dea:	e8 61 0d 00 00       	call   3b50 <printf>
  oldbrk = sbrk(0);
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3034:	68 50 4d 00 00       	push   $0x4d50
    3039:	ff 35 50 5f 00 00    	pushl  0x5f50
    303f:	e8 0c 0b 00 00       	call   3b50 <printf>
}
    ...
    306d:	6a 01                	push   $0x1
    306f:	68 11 48 00 00       	push   $0x4811
    ...
    30af:	56                   	push   %esi
    30b0:	57                   	push   %edi
    30b1:	68 b3 4c 00 00       	push   $0x4cb3
    30b6:	ff 35 50 5f 00 00    	pushl  0x5f50
    30bc:	e8 8f 0a 00 00       	call   3b50 <printf>
      exit();
    ...
    30c9:	50                   	push   %eax
    30ca:	50                   	push   %eax
    30cb:	68 35 4d 00 00       	push   $0x4d35
    30d0:	ff 35 50 5f 00 00    	pushl  0x5f50
    30d6:	e8 75 0a 00 00       	call   3b50 <printf>
    exit();
    30db:	e8 a3 08 00 00       	call   3983 <exit>
    printf(1, "pipe() failed\n");
    30e0:	52                   	push   %edx
    30e1:	52                   	push   %edx
    30e2:	68 f1 41 00 00       	push   $0x41f1
    30e7:	6a 01                	push   $0x1
    30e9:	e8 62 0a 00 00       	call   3b50 <printf>
    exit();
    ...
    30fb:	50                   	push   %eax
    30fc:	56                   	push   %esi
    30fd:	68 1c 4d 00 00       	push   $0x4d1c
    3102:	ff 35 50 5f 00 00    	pushl  0x5f50
    3108:	e8 43 0a 00 00       	call   3b50 <printf>
      kill(ppid);
    ...
    311d:	68 f9 4d 00 00       	push   $0x4df9
    3122:	ff 35 50 5f 00 00    	pushl  0x5f50
    3128:	e8 23 0a 00 00       	call   3b50 <printf>
      exit();
    312d:	e8 51 08 00 00       	call   3983 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    3132:	50                   	push   %eax
    3133:	56                   	push   %esi
    3134:	68 fc 54 00 00       	push   $0x54fc
    3139:	ff 35 50 5f 00 00    	pushl  0x5f50
    313f:	e8 0c 0a 00 00       	call   3b50 <printf>
    exit();
    3144:	e8 3a 08 00 00       	call   3983 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    3149:	51                   	push   %ecx
    314a:	51                   	push   %ecx
    314b:	68 cc 54 00 00       	push   $0x54cc
    3150:	ff 35 50 5f 00 00    	pushl  0x5f50
    3156:	e8 f5 09 00 00       	call   3b50 <printf>
    exit();
    315b:	e8 23 08 00 00       	call   3983 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    3160:	57                   	push   %edi
    3161:	56                   	push   %esi
    3162:	68 a4 54 00 00       	push   $0x54a4
    3167:	ff 35 50 5f 00 00    	pushl  0x5f50
    316d:	e8 de 09 00 00       	call   3b50 <printf>
    exit();
    3172:	e8 0c 08 00 00       	call   3983 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3177:	50                   	push   %eax
    3178:	56                   	push   %esi
    3179:	68 6c 54 00 00       	push   $0x546c
    317e:	ff 35 50 5f 00 00    	pushl  0x5f50
    3184:	e8 c7 09 00 00       	call   3b50 <printf>
    exit();
    3189:	e8 f5 07 00 00       	call   3983 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    318e:	53                   	push   %ebx
    318f:	53                   	push   %ebx
    3190:	68 01 4d 00 00       	push   $0x4d01
    3195:	ff 35 50 5f 00 00    	pushl  0x5f50
    319b:	e8 b0 09 00 00       	call   3b50 <printf>
    exit();
    31a0:	e8 de 07 00 00       	call   3983 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    31a5:	56                   	push   %esi
    31a6:	56                   	push   %esi
    31a7:	68 2c 54 00 00       	push   $0x542c
    31ac:	ff 35 50 5f 00 00    	pushl  0x5f50
    31b2:	e8 99 09 00 00       	call   3b50 <printf>
    exit();
    ...
    31c1:	57                   	push   %edi
    31c2:	57                   	push   %edi
    31c3:	68 e5 4c 00 00       	push   $0x4ce5
    31c8:	ff 35 50 5f 00 00    	pushl  0x5f50
    31ce:	e8 7d 09 00 00       	call   3b50 <printf>
    exit();
    31d3:	e8 ab 07 00 00       	call   3983 <exit>
    printf(stdout, "sbrk test fork failed\n");
    31d8:	50                   	push   %eax
    31d9:	50                   	push   %eax
    31da:	68 ce 4c 00 00       	push   $0x4cce
    31df:	ff 35 50 5f 00 00    	pushl  0x5f50
    31e5:	e8 66 09 00 00       	call   3b50 <printf>
    exit();
    ...
    3208:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    320e:	68 5e 4d 00 00       	push   $0x4d5e
    3213:	ff 35 50 5f 00 00    	pushl  0x5f50
    3219:	e8 32 09 00 00       	call   3b50 <printf>
    ...
    3257:	5a                   	pop    %edx
    3258:	56                   	push   %esi
    3259:	68 6d 4d 00 00       	push   $0x4d6d
  ...
  printf(stdout, "validate ok\n");
    ...
    327c:	68 91 4d 00 00       	push   $0x4d91
    3281:	ff 35 50 5f 00 00    	pushl  0x5f50
    3287:	e8 c4 08 00 00       	call   3b50 <printf>
}
    ...
    329e:	68 78 4d 00 00       	push   $0x4d78
    32a3:	ff 35 50 5f 00 00    	pushl  0x5f50
    32a9:	e8 a2 08 00 00       	call   3b50 <printf>
      exit();
...
000032c0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    32ca:	68 9e 4d 00 00       	push   $0x4d9e
    32cf:	ff 35 50 5f 00 00    	pushl  0x5f50
    32d5:	e8 76 08 00 00       	call   3b50 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    32f6:	68 b9 4d 00 00       	push   $0x4db9
    32fb:	ff 35 50 5f 00 00    	pushl  0x5f50
    3301:	e8 4a 08 00 00       	call   3b50 <printf>
}
    ...
    330e:	68 a8 4d 00 00       	push   $0x4da8
    3313:	ff 35 50 5f 00 00    	pushl  0x5f50
    3319:	e8 32 08 00 00       	call   3b50 <printf>
      exit();
...
00003330 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    333a:	68 c6 4d 00 00       	push   $0x4dc6
  ...
  fd = open("bigarg-ok", 0);
    ...
    335e:	6a 00                	push   $0x0
    3360:	68 c6 4d 00 00       	push   $0x4dc6
  ...
  unlink("bigarg-ok");
    337e:	c7 04 24 c6 4d 00 00 	movl   $0x4dc6,(%esp)
    ...
    3390:	c7 04 85 80 5f 00 00 	movl   $0x5520,0x5f80(,%eax,4)
    3397:	20 55 00 00 
    ...
    33a3:	51                   	push   %ecx
    33a4:	51                   	push   %ecx
    33a5:	68 d0 4d 00 00       	push   $0x4dd0
    33aa:	ff 35 50 5f 00 00    	pushl  0x5f50
    args[MAXARG-1] = 0;
    33b0:	c7 05 fc 5f 00 00 00 	movl   $0x0,0x5ffc
    33b7:	00 00 00 
    printf(stdout, "bigarg test\n");
    33ba:	e8 91 07 00 00       	call   3b50 <printf>
    exec("echo", args);
    33bf:	58                   	pop    %eax
    33c0:	5a                   	pop    %edx
    33c1:	68 80 5f 00 00       	push   $0x5f80
    33c6:	68 9d 3f 00 00       	push   $0x3f9d
    33cb:	e8 eb 05 00 00       	call   39bb <exec>
    printf(stdout, "bigarg test ok\n");
    33d0:	59                   	pop    %ecx
    33d1:	58                   	pop    %eax
    33d2:	68 dd 4d 00 00       	push   $0x4ddd
    33d7:	ff 35 50 5f 00 00    	pushl  0x5f50
    33dd:	e8 6e 07 00 00       	call   3b50 <printf>
    fd = open("bigarg-ok", O_CREATE);
    33e2:	58                   	pop    %eax
    33e3:	5a                   	pop    %edx
    33e4:	68 00 02 00 00       	push   $0x200
    33e9:	68 c6 4d 00 00       	push   $0x4dc6
    ...
    3400:	50                   	push   %eax
    3401:	50                   	push   %eax
    3402:	68 06 4e 00 00       	push   $0x4e06
    3407:	ff 35 50 5f 00 00    	pushl  0x5f50
    340d:	e8 3e 07 00 00       	call   3b50 <printf>
    exit();
    3412:	e8 6c 05 00 00       	call   3983 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3417:	52                   	push   %edx
    3418:	52                   	push   %edx
    3419:	68 ed 4d 00 00       	push   $0x4ded
    341e:	ff 35 50 5f 00 00    	pushl  0x5f50
    3424:	e8 27 07 00 00       	call   3b50 <printf>
    exit();
    ...
    3439:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    343f:	68 1b 4e 00 00       	push   $0x4e1b
    3444:	6a 01                	push   $0x1
    3446:	e8 05 07 00 00       	call   3b50 <printf>
    ...
    34c3:	50                   	push   %eax
    34c4:	68 28 4e 00 00       	push   $0x4e28
    34c9:	6a 01                	push   $0x1
    34cb:	e8 80 06 00 00       	call   3b50 <printf>
    ...
    3512:	53                   	push   %ebx
    3513:	68 44 4e 00 00       	push   $0x4e44
    3518:	6a 01                	push   $0x1
    351a:	e8 31 06 00 00       	call   3b50 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    353c:	50                   	push   %eax
    353d:	68 34 4e 00 00       	push   $0x4e34
    3542:	6a 01                	push   $0x1
    3544:	e8 07 06 00 00       	call   3b50 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    35ee:	68 54 4e 00 00       	push   $0x4e54
    35f3:	6a 01                	push   $0x1
    35f5:	e8 56 05 00 00       	call   3b50 <printf>
}
...
00003610 <uio>:
{
  ...
  printf(1, "uio test\n");
    361a:	68 6a 4e 00 00       	push   $0x4e6a
    361f:	6a 01                	push   $0x1
    3621:	e8 2a 05 00 00       	call   3b50 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    363c:	68 74 4e 00 00       	push   $0x4e74
    3641:	6a 01                	push   $0x1
    3643:	e8 08 05 00 00       	call   3b50 <printf>
}
    ...
    365e:	52                   	push   %edx
    365f:	52                   	push   %edx
    3660:	68 00 56 00 00       	push   $0x5600
    3665:	6a 01                	push   $0x1
    3667:	e8 e4 04 00 00       	call   3b50 <printf>
    exit();
    366c:	e8 12 03 00 00       	call   3983 <exit>
    printf (1, "fork failed\n");
    3671:	50                   	push   %eax
    3672:	50                   	push   %eax
    3673:	68 f9 4d 00 00       	push   $0x4df9
    3678:	6a 01                	push   $0x1
    367a:	e8 d1 04 00 00       	call   3b50 <printf>
    exit();
...
00003690 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    369b:	6a 00                	push   $0x0
    369d:	68 83 4e 00 00       	push   $0x4e83
  ...
  printf(1, "arg test passed\n");
    36d1:	58                   	pop    %eax
    36d2:	5a                   	pop    %edx
    36d3:	68 95 4e 00 00       	push   $0x4e95
    36d8:	6a 01                	push   $0x1
    36da:	e8 71 04 00 00       	call   3b50 <printf>
}
    ...
    36e7:	51                   	push   %ecx
    36e8:	51                   	push   %ecx
    36e9:	68 88 4e 00 00       	push   $0x4e88
    36ee:	6a 02                	push   $0x2
    36f0:	e8 5b 04 00 00       	call   3b50 <printf>
    exit();
...
00003700 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3704:	69 05 4c 5f 00 00 0d 	imul   $0x19660d,0x5f4c,%eax
    370b:	66 19 00 
    370e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3713:	a3 4c 5f 00 00       	mov    %eax,0x5f4c
}
    3718:	c3                   	ret    
...
00003a5b <getrcount>:
SYSCALL(getrcount)
    3a5b:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3a60:	cd 40                	int    $0x40
    3a62:	c3                   	ret    
...
00003a7b <getclcount>:
SYSCALL(getclcount)
    3a7b:	b8 20 00 00 00       	mov    $0x20,%eax
    3a80:	cd 40                	int    $0x40
    3a82:	c3                   	ret    
...
00003a8b <getotcount>:
SYSCALL(getotcount)
    3a8b:	b8 22 00 00 00       	mov    $0x22,%eax
    3a90:	cd 40                	int    $0x40
    3a92:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3aa9:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    3aac:	89 d1                	mov    %edx,%ecx
{
    3aae:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    3ab1:	85 d2                	test   %edx,%edx
    3ab3:	0f 89 7f 00 00 00    	jns    3b38 <printint+0x98>
    3ab9:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    3abd:	74 79                	je     3b38 <printint+0x98>
    neg = 1;
    3abf:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    3ac6:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    3ac8:	31 db                	xor    %ebx,%ebx
    3aca:	8d 75 d7             	lea    -0x29(%ebp),%esi
    3acd:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    3ad0:	89 c8                	mov    %ecx,%eax
    3ad2:	31 d2                	xor    %edx,%edx
    3ad4:	89 cf                	mov    %ecx,%edi
    3ad6:	f7 75 c4             	divl   -0x3c(%ebp)
    3ad9:	0f b6 92 58 56 00 00 	movzbl 0x5658(%edx),%edx
    3ae0:	89 45 c0             	mov    %eax,-0x40(%ebp)
    3ae3:	89 d8                	mov    %ebx,%eax
    3ae5:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    3ae8:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    3aeb:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    3aee:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    3af1:	76 dd                	jbe    3ad0 <printint+0x30>
  if(neg)
    3af3:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    3af6:	85 c9                	test   %ecx,%ecx
    3af8:	74 0c                	je     3b06 <printint+0x66>
    buf[i++] = '-';
    3afa:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    3aff:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    3b01:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    3b06:	8b 7d b8             	mov    -0x48(%ebp),%edi
    3b09:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    3b0d:	eb 07                	jmp    3b16 <printint+0x76>
    3b0f:	90                   	nop
    3b10:	0f b6 13             	movzbl (%ebx),%edx
    3b13:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    3b16:	83 ec 04             	sub    $0x4,%esp
    3b19:	88 55 d7             	mov    %dl,-0x29(%ebp)
    3b1c:	6a 01                	push   $0x1
    3b1e:	56                   	push   %esi
    3b1f:	57                   	push   %edi
    3b20:	e8 7e fe ff ff       	call   39a3 <write>
  while(--i >= 0)
    3b25:	83 c4 10             	add    $0x10,%esp
    3b28:	39 de                	cmp    %ebx,%esi
    3b2a:	75 e4                	jne    3b10 <printint+0x70>
    putc(fd, buf[i]);
}
    3b2c:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3b2f:	5b                   	pop    %ebx
    3b30:	5e                   	pop    %esi
    3b31:	5f                   	pop    %edi
    3b32:	5d                   	pop    %ebp
  ...
  neg = 0;
    3b38:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    3b3f:	eb 87                	jmp    3ac8 <printint+0x28>
...
{
    3b50:	f3 0f 1e fb          	endbr32 
    3b54:	55                   	push   %ebp
    3b55:	89 e5                	mov    %esp,%ebp
    3b57:	57                   	push   %edi
    3b58:	56                   	push   %esi
    3b59:	53                   	push   %ebx
    3b5a:	83 ec 2c             	sub    $0x2c,%esp
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3b5d:	8b 75 0c             	mov    0xc(%ebp),%esi
    3b60:	0f b6 1e             	movzbl (%esi),%ebx
    3b63:	84 db                	test   %bl,%bl
    3b65:	0f 84 b4 00 00 00    	je     3c1f <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
    3b6b:	8d 45 10             	lea    0x10(%ebp),%eax
    3b6e:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    3b71:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    3b74:	31 d2                	xor    %edx,%edx
  ap = (uint*)(void*)&fmt + 1;
    3b76:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3b79:	eb 33                	jmp    3bae <printf+0x5e>
    3b7b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3b7f:	90                   	nop
    3b80:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    3b83:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    3b88:	83 f8 25             	cmp    $0x25,%eax
    3b8b:	74 17                	je     3ba4 <printf+0x54>
  write(fd, &c, 1);
    ...
    3b9e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    3ba1:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3ba4:	0f b6 1e             	movzbl (%esi),%ebx
    3ba7:	83 c6 01             	add    $0x1,%esi
    3baa:	84 db                	test   %bl,%bl
    3bac:	74 71                	je     3c1f <printf+0xcf>
    c = fmt[i] & 0xff;
    3bae:	0f be cb             	movsbl %bl,%ecx
    3bb1:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3bb4:	85 d2                	test   %edx,%edx
    3bb6:	74 c8                	je     3b80 <printf+0x30>
      }
    } else if(state == '%'){
    3bb8:	83 fa 25             	cmp    $0x25,%edx
    3bbb:	75 e7                	jne    3ba4 <printf+0x54>
      if(c == 'd'){
    3bbd:	83 f8 64             	cmp    $0x64,%eax
    3bc0:	0f 84 9a 00 00 00    	je     3c60 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    3bc6:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    3bcc:	83 f9 70             	cmp    $0x70,%ecx
    3bcf:	74 5f                	je     3c30 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    3bd1:	83 f8 73             	cmp    $0x73,%eax
    3bd4:	0f 84 d6 00 00 00    	je     3cb0 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    3bda:	83 f8 63             	cmp    $0x63,%eax
    3bdd:	0f 84 8d 00 00 00    	je     3c70 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    3be3:	83 f8 25             	cmp    $0x25,%eax
    3be6:	0f 84 b4 00 00 00    	je     3ca0 <printf+0x150>
  write(fd, &c, 1);
    3bec:	83 ec 04             	sub    $0x4,%esp
    3bef:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3bf3:	6a 01                	push   $0x1
    3bf5:	57                   	push   %edi
    3bf6:	ff 75 08             	pushl  0x8(%ebp)
    3bf9:	e8 a5 fd ff ff       	call   39a3 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    3bfe:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    3c01:	83 c4 0c             	add    $0xc,%esp
    3c04:	6a 01                	push   $0x1
    3c06:	83 c6 01             	add    $0x1,%esi
    3c09:	57                   	push   %edi
    3c0a:	ff 75 08             	pushl  0x8(%ebp)
    3c0d:	e8 91 fd ff ff       	call   39a3 <write>
  for(i = 0; fmt[i]; i++){
    3c12:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
    3c16:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    3c19:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
    3c1b:	84 db                	test   %bl,%bl
    3c1d:	75 8f                	jne    3bae <printf+0x5e>
    }
  }
}
    3c1f:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3c22:	5b                   	pop    %ebx
    3c23:	5e                   	pop    %esi
    3c24:	5f                   	pop    %edi
    3c25:	5d                   	pop    %ebp
    ...
    3c38:	6a 00                	push   $0x0
    3c3a:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    3c3d:	8b 45 08             	mov    0x8(%ebp),%eax
    3c40:	8b 13                	mov    (%ebx),%edx
    3c42:	e8 59 fe ff ff       	call   3aa0 <printint>
        ap++;
    3c47:	89 d8                	mov    %ebx,%eax
    3c49:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3c4c:	31 d2                	xor    %edx,%edx
        ap++;
    3c4e:	83 c0 04             	add    $0x4,%eax
    3c51:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3c54:	e9 4b ff ff ff       	jmp    3ba4 <printf+0x54>
    3c59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printint(fd, *ap, 10, 1);
    3c60:	83 ec 0c             	sub    $0xc,%esp
    3c63:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3c68:	6a 01                	push   $0x1
    3c6a:	eb ce                	jmp    3c3a <printf+0xea>
    3c6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        putc(fd, *ap);
    3c70:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    3c73:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    3c76:	8b 03                	mov    (%ebx),%eax
  write(fd, &c, 1);
    3c78:	6a 01                	push   $0x1
        ap++;
    3c7a:	83 c3 04             	add    $0x4,%ebx
  write(fd, &c, 1);
    3c7d:	57                   	push   %edi
    3c7e:	ff 75 08             	pushl  0x8(%ebp)
        putc(fd, *ap);
    3c81:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3c84:	e8 1a fd ff ff       	call   39a3 <write>
        ap++;
    3c89:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    3c8c:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3c8f:	31 d2                	xor    %edx,%edx
    3c91:	e9 0e ff ff ff       	jmp    3ba4 <printf+0x54>
    3c96:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3c9d:	8d 76 00             	lea    0x0(%esi),%esi
        putc(fd, c);
    3ca0:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    3ca3:	83 ec 04             	sub    $0x4,%esp
    3ca6:	e9 59 ff ff ff       	jmp    3c04 <printf+0xb4>
    3cab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3caf:	90                   	nop
        s = (char*)*ap;
    3cb0:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3cb3:	8b 18                	mov    (%eax),%ebx
        ap++;
    3cb5:	83 c0 04             	add    $0x4,%eax
    3cb8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3cbb:	85 db                	test   %ebx,%ebx
    3cbd:	74 17                	je     3cd6 <printf+0x186>
        while(*s != 0){
    3cbf:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    3cc2:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    3cc4:	84 c0                	test   %al,%al
    3cc6:	0f 84 d8 fe ff ff    	je     3ba4 <printf+0x54>
    3ccc:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    3ccf:	89 de                	mov    %ebx,%esi
    3cd1:	8b 5d 08             	mov    0x8(%ebp),%ebx
    3cd4:	eb 1a                	jmp    3cf0 <printf+0x1a0>
          s = "(null)";
    3cd6:	bb 4e 56 00 00       	mov    $0x564e,%ebx
        while(*s != 0){
    3cdb:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    3cde:	b8 28 00 00 00       	mov    $0x28,%eax
    3ce3:	89 de                	mov    %ebx,%esi
    3ce5:	8b 5d 08             	mov    0x8(%ebp),%ebx
    3ce8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3cef:	90                   	nop
  write(fd, &c, 1);
    3cf0:	83 ec 04             	sub    $0x4,%esp
          s++;
    3cf3:	83 c6 01             	add    $0x1,%esi
    3cf6:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3cf9:	6a 01                	push   $0x1
    3cfb:	57                   	push   %edi
    3cfc:	53                   	push   %ebx
    3cfd:	e8 a1 fc ff ff       	call   39a3 <write>
        while(*s != 0){
    3d02:	0f b6 06             	movzbl (%esi),%eax
    3d05:	83 c4 10             	add    $0x10,%esp
    3d08:	84 c0                	test   %al,%al
    3d0a:	75 e4                	jne    3cf0 <printf+0x1a0>
    3d0c:	8b 75 d4             	mov    -0x2c(%ebp),%esi
      state = 0;
    3d0f:	31 d2                	xor    %edx,%edx
    3d11:	e9 8e fe ff ff       	jmp    3ba4 <printf+0x54>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d25:	a1 00 60 00 00       	mov    0x6000,%eax
{
    3d2a:	89 e5                	mov    %esp,%ebp
    3d2c:	57                   	push   %edi
    3d2d:	56                   	push   %esi
    3d2e:	53                   	push   %ebx
    3d2f:	8b 5d 08             	mov    0x8(%ebp),%ebx
    3d32:	8b 10                	mov    (%eax),%edx
  bp = (Header*)ap - 1;
    3d34:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d37:	39 c8                	cmp    %ecx,%eax
    3d39:	73 15                	jae    3d50 <free+0x30>
    3d3b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3d3f:	90                   	nop
    3d40:	39 d1                	cmp    %edx,%ecx
    3d42:	72 14                	jb     3d58 <free+0x38>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3d44:	39 d0                	cmp    %edx,%eax
    3d46:	73 10                	jae    3d58 <free+0x38>
{
    3d48:	89 d0                	mov    %edx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3d4a:	8b 10                	mov    (%eax),%edx
    3d4c:	39 c8                	cmp    %ecx,%eax
    3d4e:	72 f0                	jb     3d40 <free+0x20>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3d50:	39 d0                	cmp    %edx,%eax
    3d52:	72 f4                	jb     3d48 <free+0x28>
    3d54:	39 d1                	cmp    %edx,%ecx
    3d56:	73 f0                	jae    3d48 <free+0x28>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3d58:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3d5b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3d5e:	39 fa                	cmp    %edi,%edx
    3d60:	74 1e                	je     3d80 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3d62:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3d65:	8b 50 04             	mov    0x4(%eax),%edx
    3d68:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3d6b:	39 f1                	cmp    %esi,%ecx
    3d6d:	74 28                	je     3d97 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3d6f:	89 08                	mov    %ecx,(%eax)
  freep = p;
}
    3d71:	5b                   	pop    %ebx
  freep = p;
    3d72:	a3 00 60 00 00       	mov    %eax,0x6000
}
    3d77:	5e                   	pop    %esi
    3d78:	5f                   	pop    %edi
    3d79:	5d                   	pop    %ebp
    ...
    3d7f:	90                   	nop
    bp->s.size += p->s.ptr->s.size;
    3d80:	03 72 04             	add    0x4(%edx),%esi
    3d83:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3d86:	8b 10                	mov    (%eax),%edx
    3d88:	8b 12                	mov    (%edx),%edx
    3d8a:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3d8d:	8b 50 04             	mov    0x4(%eax),%edx
    3d90:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3d93:	39 f1                	cmp    %esi,%ecx
    3d95:	75 d8                	jne    3d6f <free+0x4f>
    p->s.size += bp->s.size;
    3d97:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    3d9a:	a3 00 60 00 00       	mov    %eax,0x6000
    p->s.size += bp->s.size;
    3d9f:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3da2:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3da5:	89 10                	mov    %edx,(%eax)
}
    3da7:	5b                   	pop    %ebx
    3da8:	5e                   	pop    %esi
    3da9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3dc0:	8b 3d 00 60 00 00    	mov    0x6000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3dc6:	8d 70 07             	lea    0x7(%eax),%esi
    3dc9:	c1 ee 03             	shr    $0x3,%esi
    3dcc:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    3dcf:	85 ff                	test   %edi,%edi
    3dd1:	0f 84 a9 00 00 00    	je     3e80 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3dd7:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
    3dd9:	8b 48 04             	mov    0x4(%eax),%ecx
    3ddc:	39 f1                	cmp    %esi,%ecx
    3dde:	73 6d                	jae    3e4d <malloc+0x9d>
    3de0:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    3de6:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3deb:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3dee:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
    3df5:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    3df8:	eb 17                	jmp    3e11 <malloc+0x61>
    3dfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e00:	8b 10                	mov    (%eax),%edx
    if(p->s.size >= nunits){
    3e02:	8b 4a 04             	mov    0x4(%edx),%ecx
    3e05:	39 f1                	cmp    %esi,%ecx
    3e07:	73 4f                	jae    3e58 <malloc+0xa8>
    3e09:	8b 3d 00 60 00 00    	mov    0x6000,%edi
    ...
    if(p == freep)
    3e11:	39 c7                	cmp    %eax,%edi
    3e13:	75 eb                	jne    3e00 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
    3e15:	83 ec 0c             	sub    $0xc,%esp
    3e18:	ff 75 e4             	pushl  -0x1c(%ebp)
    3e1b:	e8 eb fb ff ff       	call   3a0b <sbrk>
  if(p == (char*)-1)
    3e20:	83 c4 10             	add    $0x10,%esp
    3e23:	83 f8 ff             	cmp    $0xffffffff,%eax
    3e26:	74 1b                	je     3e43 <malloc+0x93>
  hp->s.size = nu;
    3e28:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3e2b:	83 ec 0c             	sub    $0xc,%esp
    3e2e:	83 c0 08             	add    $0x8,%eax
    3e31:	50                   	push   %eax
    3e32:	e8 e9 fe ff ff       	call   3d20 <free>
  return freep;
    3e37:	a1 00 60 00 00       	mov    0x6000,%eax
      if((p = morecore(nunits)) == 0)
    3e3c:	83 c4 10             	add    $0x10,%esp
    3e3f:	85 c0                	test   %eax,%eax
    3e41:	75 bd                	jne    3e00 <malloc+0x50>
        return 0;
  }
}
    3e43:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    3e46:	31 c0                	xor    %eax,%eax
}
    3e48:	5b                   	pop    %ebx
    3e49:	5e                   	pop    %esi
    3e4a:	5f                   	pop    %edi
    ...
    3e4c:	c3                   	ret    
    if(p->s.size >= nunits){
    3e4d:	89 c2                	mov    %eax,%edx
    3e4f:	89 f8                	mov    %edi,%eax
    3e51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    3e58:	39 ce                	cmp    %ecx,%esi
    3e5a:	74 54                	je     3eb0 <malloc+0x100>
        p->s.size -= nunits;
    3e5c:	29 f1                	sub    %esi,%ecx
    3e5e:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
    3e61:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
    3e64:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3e67:	a3 00 60 00 00       	mov    %eax,0x6000
}
    3e6c:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    3e6f:	8d 42 08             	lea    0x8(%edx),%eax
}
    3e72:	5b                   	pop    %ebx
    3e73:	5e                   	pop    %esi
    3e74:	5f                   	pop    %edi
    3e75:	5d                   	pop    %ebp
    3e76:	c3                   	ret    
    3e77:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3e7e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
    3e80:	c7 05 00 60 00 00 04 	movl   $0x6004,0x6000
    3e87:	60 00 00 
    base.s.size = 0;
    3e8a:	bf 04 60 00 00       	mov    $0x6004,%edi
    base.s.ptr = freep = prevp = &base;
    3e8f:	c7 05 04 60 00 00 04 	movl   $0x6004,0x6004
    3e96:	60 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e99:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3e9b:	c7 05 08 60 00 00 00 	movl   $0x0,0x6008
    3ea2:	00 00 00 
    if(p->s.size >= nunits){
    3ea5:	e9 36 ff ff ff       	jmp    3de0 <malloc+0x30>
    3eaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    3eb0:	8b 0a                	mov    (%edx),%ecx
    3eb2:	89 08                	mov    %ecx,(%eax)
    3eb4:	eb b1                	jmp    3e67 <malloc+0xb7>
