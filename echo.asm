...
main(int argc, char *argv[])
{
  ...
  38:	68 18 08 00 00       	push   $0x818
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	50                   	push   %eax
  41:	68 1a 08 00 00       	push   $0x81a
  46:	6a 01                	push   $0x1
  ...
  57:	68 1f 08 00 00       	push   $0x81f
  5c:	50                   	push   %eax
  5d:	68 1a 08 00 00       	push   $0x81a
  62:	6a 01                	push   $0x1
  64:	e8 47 04 00 00       	call   4b0 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 21 08 00 00       	mov    $0x821,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 d8 0a 00 00       	mov    %eax,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 7e7:	0a 00 00 
    base.s.size = 0;
 7ea:	bf dc 0a 00 00       	mov    $0xadc,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 7f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 802:	00 00 00 
    if(p->s.size >= nunits){
