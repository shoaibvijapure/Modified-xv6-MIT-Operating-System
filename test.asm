...
int main(void) 
{
  ...
  1f:	75 f2                	jne    13 <main+0x13>
            ...
            exit();
  21:	e8 cd 02 00 00       	call   2f3 <exit>
            ll x = 0;
  26:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  2d:	00 
            for (ll y = 0; y < MAX; y++) 
  2e:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  35:	00 
  36:	8b 44 24 0c          	mov    0xc(%esp),%eax
  3a:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  3f:	7f e0                	jg     21 <main+0x21>
                x = (x+y) %147;
  41:	bb 27 ae 74 6f       	mov    $0x6f74ae27,%ebx
  46:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  4d:	8d 76 00             	lea    0x0(%esi),%esi
  50:	8b 4c 24 08          	mov    0x8(%esp),%ecx
  ...
  63:	c1 fa 06             	sar    $0x6,%edx
  66:	29 c2                	sub    %eax,%edx
  68:	69 d2 93 00 00 00    	imul   $0x93,%edx,%edx
  6e:	29 d1                	sub    %edx,%ecx
  70:	89 4c 24 08          	mov    %ecx,0x8(%esp)
            for (ll y = 0; y < MAX; y++) 
  74:	8b 44 24 0c          	mov    0xc(%esp),%eax
  78:	83 c0 01             	add    $0x1,%eax
  7b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  7f:	8b 44 24 0c          	mov    0xc(%esp),%eax
  83:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  88:	7e c6                	jle    50 <main+0x50>
  8a:	eb 95                	jmp    21 <main+0x21>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 695:	a1 d0 0a 00 00       	mov    0xad0,%eax
{
 ...
 6b6:	73 10                	jae    6c8 <free+0x38>
{
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 d0 0a 00 00       	mov    %eax,0xad0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 730:	8b 3d d0 0a 00 00    	mov    0xad0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 779:	8b 3d d0 0a 00 00    	mov    0xad0,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 d0 0a 00 00       	mov    0xad0,%eax
 ...
 7d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7d7:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 d0 0a 00 00 d4 	movl   $0xad4,0xad0
 7f7:	0a 00 00 
    base.s.size = 0;
 7fa:	bf d4 0a 00 00       	mov    $0xad4,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 d4 0a 00 00 d4 	movl   $0xad4,0xad4
 806:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 812:	00 00 00 
    if(p->s.size >= nunits){
